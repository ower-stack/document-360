...
<!-- ../../../../resources/images/releases-archive/rn_cms_page_preview.gif -->
**Affected Modules**
...
For detailed migration guides, see CMS Collector Module Migration Guide from Version 1. to 2.<!--/module_migration_guides/mg-cms-collector.htm)-->.
...
<!-- ../../../../resources/images/releases-archive/rn_validity_dates_for_navigation_nodes.png -->
**Affected Modules**
...
**Documentation**
For module documentation, see Navigation Module Guide<!--/capabilities/navigation/module-navigation.htm)-->, Under the Hood - Navigation<!--/capabilities/navigation/module-navigation.htm#under-the-hood)-->.

For feature integration, see Feature Integration - Navigation<!--/capabilities/navigation/module-navigation.htm#feature-integration)-->.

For detailed migration guides see: Navigation Module Migration Guide from Version 1. to 2.<!--/module_migration_guides/mg-navigation.htm)-->, NavigationGui Module Migration Guide from Version 1. to 2.<!--/module_migration_guides/mg-navigation-gui.htm)-->.
...
**Documentation**
For detailed migration guides, see Sales Module Migration Guide from Version 7. to 8.<!--/module_migration_guides/mg-sales.htm)-->.
