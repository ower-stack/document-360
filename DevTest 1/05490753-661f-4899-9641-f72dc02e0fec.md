...
For detailed migration guides, see Discount Module Migration Guide from Version 4. to 5.<!--/module_migration_guides/mg-discount.htm)-->, Migration Guide - Discount Amounts Migration Console Command.
