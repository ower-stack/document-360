...
Time set for the product validity **Valid from** and **Valid t**o fields is accurate up to the minute. However, technically it is possible to change the accuracy (up to the second or up to the days) via a cronjob. The time is set in GMT by default.
...
* Get a general idea of the Timed Product Availability feature
* Enabling the Validity module for the Timed Product Availability feature

 

_Last review date: Feb. 23rd, 2018_ <!-- by Kyrylo Khatsko -->