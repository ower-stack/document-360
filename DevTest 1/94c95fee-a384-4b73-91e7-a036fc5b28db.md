...
Details on how to work with Javascript and templates in Spryker can be found in [Front-Ende Guide](https://documentation.spryker.com/front-end_developer_guide/user-interface-guide.htm).

Econda module uses collectors to [export data to CSV](econda-export-csvs.htm). Please read more about [Collectors](https://documentation.spryker.com/capabilities/development/collector/collector-development.htm).
...
* [Cross Sell - Econda](econda-cross-sell.htm)
* [Exporting CSVs to Econda](econda-export-csvs.htm)
* [Tracking - Econda](econda-tracking.htm)