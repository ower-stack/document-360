Query objects provide an object-oriented API for writing database queries which are used in [query containers](https://documentation.spryker.com/zed/persistence_layer/query_container.htm).
