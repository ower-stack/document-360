...
Now, you need to create a publication queue. It will be used to synchronize published data to the frontend. It is recommended to have a separate queue for each *Redis* or *Elasticsearch* entity. For information on how to create a queue, see [Set Up a "Hello World" Queue](https://documentation.spryker.com/tutorials/introduction/setup-hello-world-queue.htm), section **Creating a Simple Queue**.
...
Implementing a listener is detailed in [Listening to Events](https://documentation.spryker.com/capabilities/development/event/event-listen.htm). Follow the guide to create your listener classes.
