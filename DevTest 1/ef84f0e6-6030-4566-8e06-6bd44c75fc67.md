@(Info)()(The following article describes  how to build your own DataImport for a specific type. All steps in this article are built on the real life example for importing product images.)
...
<!--../../resources/images/product_image_import_database_schema_thumb_0_48.png-->
...
* concrete_sku
* abstract_sku
<!-- ../../resources/images/product_image_import_csv_file_example_thumb_0_48.png-->
...
@(Info)()(The constant is used to identify an import type. More information about it will follow later in this article. In our case we will use const `IMPORT_TYPE_PRODUCT_IMAGE = 'product-image';`.)
...
<!-- ../../resources/images/product_image_import_console_output_thumb_0_48.png -->