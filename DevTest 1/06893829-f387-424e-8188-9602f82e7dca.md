...
## 1. Installation
To be able to validate REST requests, first, you need to install the `RestRequestValidation` Module that provides the functionality. For details, see _Request Validation Integration_.
...
3. Provide validation for the endpoints provided by the API. For details, see _Validation Rule Format_.
