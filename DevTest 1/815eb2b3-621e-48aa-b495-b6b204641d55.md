...
@(Error)()(It is important to always pass **required** properties, otherwise, the component you are including will fail.)
...
@(Info)()(For more details, see section _Twig_ in _Atomic Frontend_.)
...
@(Info)()(See component implementation in _How To Create a Component_. <!-- https://documentation.spryker.com/tutorials/introduction/customizefrontend/t-create-component.htm -->)
...
@(Info)()(You can find the original Twig of the component in the _Create Component Template_ section of _How To Create a Component_. <!-- https://documentation.spryker.com/tutorials/introduction/customizefrontend/t-create-component.htm -->)

Now, let us check how it looks like on the page.
<!-- ../../../resources/images/frontend/updated-embedded-element.png -->