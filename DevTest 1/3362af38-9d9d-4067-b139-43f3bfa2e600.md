...
For information on how to work with RabbitMQ, see [this tutorial](https://www.rabbitmq.com/tutorials/tutorial-one-php.html) or run:
...
![rabbitmq_worker.png](https://cdn.document360.io/9fafa0d5-d76f-40c5-8b02-ab9515d3e879/Images/Documentation/rabbitmq_worker.png){height="" width=""}
...
@(Info)()(For more information and examples of how to get started with the Queue module see Tutorial - Set Up a "Hello World" Queue.)
...
_Last review date: Apr 9th, 2019_ <!-- by Ehsan Zanjani and Dmitry Beirak -->