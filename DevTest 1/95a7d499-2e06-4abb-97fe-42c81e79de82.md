@(Info)()(This month we released some important security updates. Check them out here<!--/about_spryker/what_s_new/security-updates.htm)-->.)
...
For detailed migration guides, see Shipment Module Migration Guide from Version 5. to 6.<!--/module_migration_guides/mg-shipment.htm)-->
For store administration guides, see Shipment Store Administration Guide<!--/administration_interface_guide/shipment.htm)-->
For other related documentation see: HowTo - Add New Shipment Method<!--/tutorials/howtos/ht-add-new-shipment-method-2.htm)-->
...
**Documentation**
For detailed migration guides, see RabbitMQ Module Migration Guide from Version 0. to 1.<!--/module_migration_guides/mg-rabbitmq.htm)-->.
...
* Queue Integration - Loggly<!--/industry_partners/performance/loggly-queue.htm)-->
* Payolution — Configuration<!--/industry_partners/payment/payolution/payolution-configuration.htm)-->
* Payolution — Workflow<!--/industry_partners/payment/payolution/payolution-workflow.htm)-->
