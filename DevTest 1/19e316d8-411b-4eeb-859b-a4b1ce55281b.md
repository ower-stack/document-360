...
* Getting a general idea of the Shipment feature
* Getting a overview of the Shipment module
* Migrating to a newer version of the Shipment module
...
_Last review date: Oct. 27th, 2017_ <!-- by Karoly Gerner -->