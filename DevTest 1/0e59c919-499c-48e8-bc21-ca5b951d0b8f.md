...
@(Warning)()(If you have not installed plugins needed for [Merchant and Merchant Relations](http://documentation.spryker.com/capabilities/company_account/merchants_and_merchant_relations/merchants-and-merchant-relations.htm), add them here as well. See Merchant and Merchant Relations feature integration guide <!-- link to IG--> for more details.)
...
@(Info)()(See  [Migration Guide - PriceProduct](https://documentation.spryker.com/module_migration_guides/mg-priceproduct.htm) for information on how to migrate to a newer version of the `PriceProduct` module with price dimensions support.)