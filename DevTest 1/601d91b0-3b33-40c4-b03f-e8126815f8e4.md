...
* **GiftCard**: implements the basic functionality of the Gift Cards feature as  well as the [Replacement value-checking strategy](https://documentation.spryker.com/capabilities/gift_cards/gift_card_purchase_and_management/gift-cards-purchase-redeeming.htm).
