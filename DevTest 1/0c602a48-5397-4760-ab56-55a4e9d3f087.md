This tutorial provides instructions on how to implement Widgets and Widget Plugins into _Modular Frontend_ <!-- add link to Related section once published https://documentation.spryker.com/front-end_developer_guide/yves/modular-frontend.htm --> . 
