...
1. Open RDS console. <!-- ../../resources/images/spryker-aws-installation/rds-console.png-->
2. Click **Create database**. <!-- ../../resources/images/spryker-aws-installation/create-database.png -->
3. Select **PostgreSQL**. <!-- ../../resources/images/spryker-aws-installation/choose-postgresql.png -->
4. Choose a use case ( For production purpose, we recommend Multi-AZ Deployment). <!-- ../../resources/images/spryker-aws-installation/choose-use-case.png -->
5. Fill out all the outlined fields. <!-- ../../resources/images/spryker-aws-installation/choose-db-details.png 
../../resources/images/spryker-aws-installation/db-login-details.png
../../resources/images/spryker-aws-installation/network-and-security.png
../../resources/images/spryker-aws-installation/db-options.png-->
6. Get **DB Name**, **Endpoint** and **port**. <!-- ../../resources/images/spryker-aws-installation/get-db-name-endpoint.png -->
...
1. Open Elasticsearch service console. <!-- ../../resources/images/spryker-aws-installation/elastic-search-console.png -->
2. Click **Create a new domain**. <!-- ../../resources/images/spryker-aws-installation/create-new-domain.png -->
3. Fill out all the outlined fields. <!-- ../../resources/images/spryker-aws-installation/define-domain.png 
../../resources/images/spryker-aws-installation/node-config.png
../../resources/images/spryker-aws-installation/vpc-access.png-->
4. Get **VPC endpoint**. <!-- ../../resources/images/spryker-aws-installation/get-vpc-endpoint.png -->
...
1. Open ElastiCache console. <!-- ../../resources/images/spryker-aws-installation/elasticache-console.png -->
2. Click **Get Started Now**. <!-- ../../resources/images/spryker-aws-installation/elastisearch-start.png -->
3. Fill out all the outlined fields. <!-- ../../resources/images/spryker-aws-installation/elastisearch-config.png 
../../resources/images/spryker-aws-installation/redis-settings.png-->
4. Get **Primary Endpoint**. <!-- ../../resources/images/spryker-aws-installation/get-primary-endpoint.png -->
...
1. Open EC2 console. <!-- ../../resources/images/spryker-aws-installation/ec2-console.png -->
2. Click **Create Security Group**. <!-- ../../resources/images/spryker-aws-installation/create-security-group.png -->
3. Fill out the outlined fields and click **Create**. <!-- ../../resources/images/spryker-aws-installation/choose-security-group.png -->
...
1. Open EC2 console. <!-- ../../resources/images/spryker-aws-installation/ec2-console.png -->
2. Click **Allocate new address**. <!-- ../../resources/images/spryker-aws-installation/allocate-new-address.png -->
3. Leave the default setup and click **Allocate**. <!-- ../../resources/images/spryker-aws-installation/allocate.png -->
4. Click **Actions** > **Associate address**. <!-- ../../resources/images/spryker-aws-installation/associate-address.png -->
5. Choose Spryker instance and click **Associate**. <!-- ../../resources/images/spryker-aws-installation/choose-spryker-instance.png -->
...
1. Open EC2 console. <!-- ../../resources/images/spryker-aws-installation/ec2-console.png -->
2. Click **Launch instance**. <!-- ../../resources/images/spryker-aws-installation/launch-instance.png -->
3. Select the Ubuntu server with the **64-bit (x86)** configuration. <!-- ../../resources/images/spryker-aws-installation/choose-os.png -->
4. Choose the instance type and click **Next: Configure Instance Details**.<!-- ../../resources/images/spryker-aws-installation/choose-instance.png -->
5. Add storage and click **Next: Add Tags**. <!-- ../../resources/images/spryker-aws-installation/add-storage.png -->
6. Add a Name tag and click **Next: Configure Security Group**. <!-- ../../resources/images/spryker-aws-installation/add-tags.png -->
7. Choose the security group which you have previously created and click **Review and Launch**.
8. Choose the ssh key you have previously created, download it and click **Launch Instances**. <!-- ../../resources/images/spryker-aws-installation/select-ssh-key.png -->

### Connecting to the instance

1. Click **Actions** > **Connect**. <!-- ../../resources/images/spryker-aws-installation/actions-connect.png -->
2. Connect to the Spryker instance using the provided details. <!-- ../../resources/images/spryker-aws-installation/connection-instructions.png -->
...
<!-- ../../resources/images/spryker-aws-installation/connections-list.jpg -->
</br>
</details>