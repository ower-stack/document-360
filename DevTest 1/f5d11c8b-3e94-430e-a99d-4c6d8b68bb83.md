...
1. Re-partition the entire hard drive with case-sensitivity turned onю
2. Create a new partition and re-format only this new partition with the case-sensitive file-systemю
3. Create a disk image, format that image with the case-sensitive file-system, and mount this disk imageю
...
<!-- ../../resources/images/case_sensitive_system.png -->
...
If you want to know more about this you can find documentation [here](https://confluence.jetbrains.com/display/IDEADEV/Filesystem+Case-Sensitivity+Mismatch). 
 
_Last review date: Nov 22, 2016_
