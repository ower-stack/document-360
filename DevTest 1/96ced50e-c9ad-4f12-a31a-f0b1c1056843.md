...
@(Info)(Info)(`GLUE_APPLICATION_DOMAIN` should be configured for every domain used in project.)
...
```
**Verification**
@(Info)()(If everything has been set up correctly, you should be able to access http://glue.example.com/ and see the correct JSON response:)
```JSON
{
    "errors": [
        {
...
```
 *Last review date: Feb. 25th, 2019* <!-- by  Anton Khabiuk and Dmitry Beirak-->