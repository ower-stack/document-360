    ...
    <div class="mr-list-container">
        ...
        <div class="mr-col">
            <ul class="mr-list mr-list-red">
                ...
                <li><a href="https://documentation.spryker.com/v3/docs/shop-guide-managing-shopping-carts#sharing-a-cart-via-link-with-the-external-users" class="mr-link">Share a cart via a link with external users</a></li>
                <li><a href="https://documentation.spryker.com/v3/docs/shop-guide-managing-shopping-carts#sharing-a-cart-via-link-with-the-internal-users" class="mr-link">Share a cart via a link with internal users</a></li>
           </ul>
        </div>
    </div>
</div>