...
3. In the **Rule** section, enter and select the following and click **Add Rule**:
    ...
    * Action
    * Permission
See [Roles: Reference Information](https://documentation.spryker.com/v4/docs/user-reference-information) to know more about the attributes that you need to enter.
