...
@(Info)(Information)(The following imported entities will be used as carts to the company user relations in the Spryker OS.)
...
@(Info)(Information)(This feature requires the database storage strategy enabled in the quote module.)
