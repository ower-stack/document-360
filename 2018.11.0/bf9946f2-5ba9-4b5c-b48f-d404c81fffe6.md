...
![](../Resources/Images/Shop User Guide/Quick Order/quick-order-widget.png)
...
<div class="mapster-container">
            <img class="mapster-image" src="../Resources/Images/Shop User Guide/Quick Order/quick-order-ui.png" usemap="#Map" data-mapster-config="" />
...
@(Warning)()(You can configure a drop-down list with available carts on project level. By default, this box is hidden.)

@(Info)()(**Add to Shopping List** button is only available for the authorized users.)

## Creating a New Quick Order

To **create a new quick order**, do the following:

1. On the *Quick Order* page populate all required information: enter the product SKU or Iten Name and the required Quantity.
@(Warning)()(Keep in mind, that if quantity restrictions apply to the product, they will be reflected here as well. See Quantity Restrictions for Quick Order to learn more about how the quantity limitations are applied to the Quick Order form.)
2. Click **Create Order**.

## Adding the Products into the Quick Order Form in Bulk
...
@(Warning)()(By default, [SKU, Qty] format is used for filling the form in Spryker B2B Demo Shop.)

![](../Resources/Images/Shop User Guide/Quick Order/quick-order-add-articles.png)

## Uploading Products Using Upload Form

@(Warning)()(This option is only available if you installed File Upload Concrete Products feature.)

To upload the products using the upload form, do the following:

1. Browse a .csv file by clicking **Browse File** area:
![](../Resources/Images/Shop User Guide/Quick Order/upload-your-order-browse-file.png) You can download a file template by clicking **Click here to download a csv template**: ![](../Resources/Images/Shop User Guide/Quick Order/upload-your-order-download-template.png)
...
![](../Resources/Images/Shop User Guide/Quick Order/select-list-quick-order.png)
3. Click **Add to Shopping List** button.
...
* [Go to Checkout](https://documentation.spryker.com/v3/docs/checkout-shop-guide)
