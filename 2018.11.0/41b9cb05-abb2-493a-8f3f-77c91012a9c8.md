<details open>
<summary>Upgrading from Version 10.* to Version 11.0.0</summary>
...
<details open>
<summary>Upgrading from Version 8.* to Version 10.0.0</summary>
...
<details open>
<summary>Upgrading from Version 7.* to Version 8.*</summary>
...
<details open>
<summary>Upgrading from Version 6.* to Version 7.*</summary>
...
<details open>
<summary>Upgrading from Version 5.* to Version 6.*</summary>
...
@(Error)(Important)(Do not run any propel commands when executing this, it will drop foreign keys without giving you chance to migrate data.)
...
@(Info)()(As of Sales module version 6, all  foreign keys to customer and shipment were removed, so that Sales related tables won't have hard relations to other concepts like shipment and customer. This separation allows having services based on bound contexts. 
...
@(Info)(7. Verification step:)(It is important to see if the data migration went well. To check, look at the tables: `spy_sales_shipment` and `spy_sales.customer_reference`. If they are populated, you can drop the old foreign keys.)
...
1. To keep old calculation logic see [Updating calculator stacks](https://docs.demo-spryker.com/v1/docs/mg-calculation).
2. To migrate to the new structure see [Migrating sales to new calculator logic](https://docs.demo-spryker.com/v1/docs/mg-calculation). 

</br>
</details>

<details open>
<summary>Upgrading from Version 3.* to Version 4.*</summary>
...
@(Error)(Important)(Please update your templates if overwritten.)
