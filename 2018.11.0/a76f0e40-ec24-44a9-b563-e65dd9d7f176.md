...
![Database for tax sets](https://spryker.s3.eu-central-1.amazonaws.com/docs/Features/tax.png){height="" width=""}
...
@(Info)(Tax Related Entities)(There are a couple of entities that have a tax set associated as a foreign key, such as abstract products, product options and shipment methods.)
...
## Migration Guide
If you’re migrating the Tax module from version 2 to version 3, you need to follow the steps described in the [Migration Guide - Tax](https://documentation.spryker.com/v4/docs/mg-tax).