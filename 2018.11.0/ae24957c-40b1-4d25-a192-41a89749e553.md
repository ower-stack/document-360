...
1. Open a terminal.
@(Info)()(In case you are going to run the script on Windows, open Ubuntu (Learn about it [here](https://documentation.spryker.com/v3/docs/docker-install-prerequisites-windows-201907#Install).))
...
Learn more about development mode [here](https://documentation.spryker.com/v3/docs/spryker-in-docker-dev-mode-201907).
...
4. In the meanwhile, if you haven't installed the CA certificate, take `spryker.crt` from `/docker/deployment/default/` and follow the [instructions](https://documentation.spryker.com/v3/docs/ht-install-self-signed-ssl-certificates-201907).
...
* [Docker Installation Prerequisites](https://documentation.spryker.com/v3/docs/docker-install-prerequisites-201907)
