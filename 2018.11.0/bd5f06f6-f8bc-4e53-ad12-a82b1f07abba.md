...
The volume prices are imported using [data importer](https://github.com/spryker/spryker/blob/master/Bundles/PriceProductDataImport/data/import/product_price.csv). The JSON with volume prices is added to price_data.volume_prices column as shown in the example:
...
* volume prices cannot be applied to the [prices per merchant relation](https://documentation.spryker.com/v4/docs/price-per-merchant-relation).
