...
Upgrade `spryker/cms` module to at least 6.2 version. See [Migration Guide - CMS](https://documentation.spryker.com/v4/docs/mg-cms) for more details.
...
* [Learn more about CMS Widget](https://documentation.spryker.com/v4/docs/cms-widget)

_Last review date: Sep. 22, 2017_ <!-- by Karoly Gerner  -->