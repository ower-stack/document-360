...
![image](https://spryker.s3.eu-central-1.amazonaws.com/docs/User+Guides/Shop+User+Guides/Shopping+Lists/header-shopping-lists.png){height="" width=""}

2. In your **Customer Account**, select **Shopping Lists** on the left-side navigation bar. 
![image](https://spryker.s3.eu-central-1.amazonaws.com/docs/User+Guides/Shop+User+Guides/Shopping+Lists/shopping-list-shop-guide.png){height="" width=""}

## Graphic User Interface

@(Info)()(Hover your mouse over the numbers to view their description.)
![image](https://spryker.s3.eu-central-1.amazonaws.com/docs/User+Guides/Shop+User+Guides/Shopping+Lists/shop-lists-gui.png){height="" width=""}
...
https://spryker.s3.eu-central-1.amazonaws.com/docs/User+Guides/Shop+User+Guides/Shopping+Lists/create-shopping-list-btn.png
...
![image](https://spryker.s3.eu-central-1.amazonaws.com/docs/User+Guides/Shop+User+Guides/Shopping+Lists/add-to-shopping-list-btn.png){height="" width=""}
...
![image](https://spryker.s3.eu-central-1.amazonaws.com/docs/User+Guides/Shop+User+Guides/Shopping+Lists/edit-btn.png){height="" width=""}
...
![image](https://spryker.s3.eu-central-1.amazonaws.com/docs/User+Guides/Shop+User+Guides/Shopping+Lists/quick-add-to-shopping-list-window.png){height="" width=""}

@(Warning)()(To be able to search for products, make sure that [Search Widget for Concrete Products](https://documentation.spryker.com/v3/docs/search-widget-for-concrete-products-overview-201903) feature is [integrated](https://documentation.spryker.com/v3/docs/search-widget-for-concrete-products-integration) into your Project.)

* View the shopping list owner and access rights.
![image](https://spryker.s3.eu-central-1.amazonaws.com/docs/User+Guides/Shop+User+Guides/Shopping+Lists/view-owner-on-edit-page.png){height="" width=""}

* View the shopping list details: its price, name, SKU, etc.
* Change the product item quantity using minus and plus buttons.
![image](https://spryker.s3.eu-central-1.amazonaws.com/docs/User+Guides/Shop+User+Guides/Shopping+Lists/view-details.png){height="" width=""}
...
![image](https://spryker.s3.eu-central-1.amazonaws.com/docs/User+Guides/Shop+User+Guides/Shopping+Lists/warranty-options.png){height="" width=""}

* Select the insurance option.
![image](https://spryker.s3.eu-central-1.amazonaws.com/docs/User+Guides/Shop+User+Guides/Shopping+Lists/insurance-option.png){height="" width=""}

* Remove the item from the shopping list.
![image](https://spryker.s3.eu-central-1.amazonaws.com/docs/User+Guides/Shop+User+Guides/Shopping+Lists/remove-btn.png){height="" width=""}
...
![image](https://spryker.s3.eu-central-1.amazonaws.com/docs/User+Guides/Shop+User+Guides/Shopping+Lists/share-btn.png){height="" width=""}
...
@(Info)()(See [Permissions Management for Shared Shopping Lists](https://documentation.spryker.com/v4/docs/printing-shopping-list) to learn more about types of shopping list access rights.)
![image](https://spryker.s3.eu-central-1.amazonaws.com/docs/User+Guides/Shop+User+Guides/Shopping+Lists/share-page.png){height="" width=""}
...
![image](https://spryker.s3.eu-central-1.amazonaws.com/docs/User+Guides/Shop+User+Guides/Shopping+Lists/print-btn.png){height="" width=""}
...
![image](https://spryker.s3.eu-central-1.amazonaws.com/docs/User+Guides/Shop+User+Guides/Shopping+Lists/printable-shopping-list.png){height="" width=""}


### Deleting a Shopping List

Clicking **Delete** will delete a shopping list from your shopping lists.
![image](https://spryker.s3.eu-central-1.amazonaws.com/docs/User+Guides/Shop+User+Guides/Shopping+Lists/delete-btn.png){height="" width=""}
...
![image](https://spryker.s3.eu-central-1.amazonaws.com/docs/User+Guides/Shop+User+Guides/Shopping+Lists/place-order.png){height="" width=""}

The shopping list with the available items will be added to the shopping cart. See [Shopping Cart](https://documentation.spryker.com/v3/docs/shop-guide-managing-shopping-carts) to learn how to manage and purchase items using the cart.
...
![image](https://spryker.s3.eu-central-1.amazonaws.com/docs/User+Guides/Shop+User+Guides/Shopping+Lists/dismiss-btn.png){height="" width=""}
...
*    [Shopping List](https://documentation.spryker.com/v3/docs/shopping-list)
*    [Shopping List Notes](https://documentation.spryker.com/v3/docs/shopping-list-notes)
*    [Multiple and Shared Shopping Lists Feature Overview](https://documentation.spryker.com/v3/docs/printing-shopping-list)
*    [Printing a Shopping List](https://documentation.spryker.com/v3/docs/printing-a-shopping-list)
