...
![Database entityt relation schema](https://spryker.s3.eu-central-1.amazonaws.com/docs/Features/Product+Management/db_relation_schema.png){height="" width=""}
...
@(Info)()(If a product matches in that locale it will be related in both locales.)
...
@(Info)()(These rules can be combined with and or or operators, and it is also possible to nest them to make complex rules.)
...
@(Info)()(This command can also be executed by spryker cron jobs and manually triggered via Jenkins.)
...
@(Info)()(The new collector uses product_relation type in the `touch` table.)
...
_Last review date: Mar 29, 2019_ <!-- by Anastasia Datsun -->