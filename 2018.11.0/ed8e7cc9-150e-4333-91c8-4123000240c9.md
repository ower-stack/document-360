...
![Discount promotion products](https://spryker.s3.eu-central-1.amazonaws.com/docs/About/Archive/RN_discount_promotion_products.gif){height="" width=""}

![Discount promotion products in Zed](https://spryker.s3.eu-central-1.amazonaws.com/docs/About/Archive/RN_discount_promotion_products_zed.gif){height="" width=""}
...
**Documentation**
For module documentation, see [Discount Module Guide](https://documentation.spryker.com/v4/docs/discount), Extending the Discount Module, [Discount Promotions](https://documentation.spryker.com/v4/docs/promotions-discount).
...
![Discount ratings](https://spryker.s3.eu-central-1.amazonaws.com/docs/About/Archive/RN_product_reviews_and_ratings.gif){height="" width=""}

![Discount ratings in Zed](https://spryker.s3.eu-central-1.amazonaws.com/docs/About/Archive/RN_product_reviews_and_ratings_zed.gif){height="" width=""}
...
**Documentation**
For documentation, see [Under the Hood - Product Reviews](https://documentation.spryker.com/v4/docs/product-review-under-the-hood), Product Reviews Feature Configuration, [Filter and Sort by Average Rating](https://documentation.spryker.com/v4/docs/product-review-filter-and-sort)

For feature integration, see [Feature Integration - Product Reviews](https://documentation.spryker.com/v4/docs/product-review-feature-integration).
