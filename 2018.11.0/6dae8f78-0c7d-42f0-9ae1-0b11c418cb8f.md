...
Your development environment needs to be updated with Elasticsearch 5.6.x. In case you are using the Spryker DevVM, you can download the latest release that provides the necessary services. Follow our *Installation Guide* <!-- add a link --> for detailed instructions about installing the Spryker DevVM.
...
<details open>
<summary>Upgrading from Version 4.* to Version 5.*</summary>
...
Please check the Search documentation for a detailed [example](https://documentation.spryker.com/capabilities/search_and_filter/configure-search-features.htm).
