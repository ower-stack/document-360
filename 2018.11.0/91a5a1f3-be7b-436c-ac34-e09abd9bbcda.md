...
In this new version of the **OrdersRestApi** module, we have added support of split delivery. You can find more details about the changes on the [OrdersRestApi module release page](https://github.com/spryker/orders-rest-api/releases).
