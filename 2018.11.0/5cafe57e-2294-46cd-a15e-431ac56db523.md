...
**See also:**
* [Get an overview of the Company Account feature](https://documentation.spryker.com/v4/docs/company-account-overview)
* [Manage Company User roles and permissions](https://documentation.spryker.com/v4/docs/company-user-permissions)

_Last review date: Oct 3, 2018_ <!-- by Vitaliy Kirichenko -->