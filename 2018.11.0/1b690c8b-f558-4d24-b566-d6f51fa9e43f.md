...
![EventQueue](https://spryker.s3.eu-central-1.amazonaws.com/docs/Tutorials/event-queue-no-events.png){height="" width=""}
...
![sync storage ](https://spryker.s3.eu-central-1.amazonaws.com/docs/Tutorials/sync-queue-event.png){height="" width=""}
...
@(Warning)()(To run all queues at once, you can run the following command: `console queue:worker:start -vvv`.)
...
@(Warning)()(To explore Redis storage, connect Redis Desktop Manager to [http://zed.de.suite.local:10009](http://zed.de.suite.local:10009/).)
