...
![threshold-with-fixed-fee.png](https://cdn.document360.io/9fafa0d5-d76f-40c5-8b02-ab9515d3e879/Images/Documentation/threshold-with-fixed-fee.png){height="" width=""}
...
![minimum-order-value-schema.jpg](https://cdn.document360.io/9fafa0d5-d76f-40c5-8b02-ab9515d3e879/Images/Documentation/minimum-order-value-schema.jpg){height="" width=""}

@(Info)()(Keep in mind, that fees for the soft thresholds are based on sub-total and not grand-total values of orders. Fixed and flexible fees are added in a separate line as expenses for orders.)
...
The thresholds for the minimum order values are set by individual merchants globally in the dedicated area of the Administration Interface. This means that threshold values set by them are applied to all of their customers.
...
![context-of-the-minimum-order-value-module.png](https://cdn.document360.io/9fafa0d5-d76f-40c5-8b02-ab9515d3e879/Images/Documentation/context-of-the-minimum-order-value-module.png){height="" width=""}
