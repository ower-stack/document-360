...
1. Upgrade the `Content` Module to version 2.0.0. Follow the steps described in [Migration Guide - Content](https://documentation.spryker.com/v3/docs/mg-content-201907).
2. Upgrade the `ContentBanner` to version 2.0.0. Follow the steps described in [Migration Guide - ContentBanner](https://documentation.spryker.com/v3/docs/mg-contentbanner-201907).
...
  
**See also:**
* [Learn how to migrate to a new version of the Content module](https://documentation.spryker.com/v3/docs/mg-content-201907)
* [Learn how to migrate to a new version of the ContentBanner module](https://documentation.spryker.com/v3/docs/mg-contentbanner-201907)
