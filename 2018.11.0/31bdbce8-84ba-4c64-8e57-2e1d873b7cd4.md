Query objects provide an object-oriented API for writing database queries which are used in [query containers](https://documentation.spryker.com/v4/docs/query_container.htm).
