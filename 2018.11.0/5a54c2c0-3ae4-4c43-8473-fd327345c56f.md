...
@(Error)(Important)(Keep in mind that starting with the version **201907.0**, the content widget menu has been disabled. However, you can use content items widgets instead. See the _Content Item Widgets_ articles to learn how to work with them.)