...
2. On the **Create Discount page > General tab**, do the following:
   ...
   3. In the **Name** field, specify the name for the voucher.
    ...
    5. Specify if the voucher is exclusive. See _Discount: Reference Information_
 ...
 4. On the **Create Discount page >Discount calculation** tab, do the following:
    ...
    2. Select the **Discount application type** and define what products the voucher will be applied to. See _Discount Calculation: Reference Information_.
...
@(Info)()(See _Voucher Codes: Reference Information_ for more details.)
***
**Tips & Tricks**
