...
**See also:**
[Category Filters Overview](https://documentation.spryker.com/v4/docs/category-filters)
[Creating and Managing Category Filters](https://documentation.spryker.com/v4/docs/managing-category-filters)

_Last review date: Dec 1, 2017_ 
