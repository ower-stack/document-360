...
Version 7.0.0 of the CMS module introduces the multi-store functionality. The multi-store CMS page feature enables management of CMS page display per store via a store toggle control in the Admin UI.
...
@(Warning)()(Before migrating a production database, always review each SQL statement individually, even when there are many of them.)
...
@(Warning)()(Don't forget to sync your newly updated Zed data with the storage tables.)
...
@(Warning)()(Before upgrading, make sure that you do not use any deprecated code from version 3|4.*. Check the description of the deprecated code (inside the code) to see what you will need to use instead.)
...
* [Learn how to use CMS](https://documentation.spryker.com/v2/docs/pages-201903)
...
* [Learn how to migrate CMS Block Collector](https://documentation.spryker.com/v4/docs/mg-cms-block-collector)
* [Learn how to migrate CMS Block Category Connector](https://documentation.spryker.com/v4/docs/mg-cms-block-category-connector-console)
* [Learn how to migrate CMS Collector](https://documentation.spryker.com/v4/docs/mg-cms-collector)