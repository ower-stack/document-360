...
@(Error)(Important!)(Even if a response has status code 200 it still may contain Constraint(s) in the response body.)
...
* [Get a general idea about Amazon Pa](https://documentation.spryker.com/v4/docs/)y
* C[onfigure Amazon Pay](https://documentation.spryker.com/v4/docs/)
* [Obtaining Amazon Order Reference and Shipping Addresses details](https://documentation.spryker.com/v4/docs/)
* [Learn how Amazon Pay Refund works](https://documentation.spryker.com/v4/docs/)
* [Rendering the "Pay with Amazon" button on the Cart page](https://documentation.spryker.com/v4/docs/)
* [Learn how Amazon Pay Sandbox Simulations work](https://documentation.spryker.com/v4/docs/)
* [Learn about Amazon Pay state machine for synchronous and asynchronous flows](https://documentation.spryker.com/v4/docs/)
* [Check out Amazon Pay example email notifications](https://documentation.spryker.com/v4/docs/)
* [Check support of bundled products with Amazon](https://documentation.spryker.com/v4/docs/)
