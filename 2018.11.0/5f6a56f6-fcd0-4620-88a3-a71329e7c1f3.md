The topic describes how to edit CMS pages in Back Office.
***
...
1. Select **Edit** > **Page**.
2.  On the _Edit CMS Page: [Page Name]_ page that opens, you can see the following:
    In the **General** tab:
    * Store relation
    * Template
...
![image.png](https://cdn.document360.io/9fafa0d5-d76f-40c5-8b02-ab9515d3e879/Images/Documentation/image%28119%29.png){height="" width=""}

@(Info)()(In the placeholders editor, you can insert a banner, abstract product list, product set, and downloadable files using content item widgets. See the _Adding Content Item Widgets to a Page_ article for more details. )
***
**Tips & Tricks**
