...
@(Warning)(Verification)(The following imported entities will be used as shopping lists in Spryker OS.)
...
@(Warning)(Verification)(The following imported entities will be used as shopping lists being directly shared with specific company users in Spryker OS.)
...
@(Warning)(Verification)(The following imported entities will be used as shopping lists being directly shared with specific company business units in Spryker OS.)
