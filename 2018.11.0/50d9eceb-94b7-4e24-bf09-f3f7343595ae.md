...
<table>
    ...
    <tbody>
        <tr>
            <td rowspan=5>Developer</td>
            <td >Project Software Engineer</td>
            <td>An engineer who implements project requirements reusing Spryker OS and the Spryker infrastructure.</td>
        </tr>
        <tr>
            <td>Product Software Engineer</td>
            <td>An engineer who builds Spryker Core.</td>
        </tr>
        <tr>
            <td>Backend Developer</td>
            <td>Their main tasks are creating new and updating existing backend features.</td>
        </tr>
        <tr>
            <td>Frontend Developer</td>
            <td>Their main tasks are creating and updating the frontend part of the existing features. </td>
        </tr>
        <tr>
            <td>Site Administrator / DevOps</td>
      ...
      <tbody>
        <tr>
            <td rowspan=11>Back Office User</td>
            <td >eCommerce Manager</td>
            <td>An E-Commerce Manger is responsible for: <ul>
                <li>The entire E-Commerce business and revenue</li>
                <li>Strategical development of the E-Commerce platform</li>
...
<li>Customer satisfaction</li>
        ...
        <tr>
            <td>Marketing SEO Manager </td>
            <td>Marketing SEO Manager  is responsible for:<ul>
                <li>Traffic acquisition through organic search channel</li>
                <li>Management of the SEO team</li>
                <li>Coordination with the Marketing content team</li>
                <li>Periodic reporting to the main stakeholders</li>
                <li>Draw conclusions about the SEO initiatives RO</li></ul>
</td>
        </tr>
        <tr>
            <td>Fulfillment / Order Manager</td>
            <td>Responsibilities:<ul>
                <li>Accept/Refuse new orders</li>
...
<li>Manage information transfer between the commerce system and the fulfillment provider software</li>
        ...
        <tr>
            <td>Catalog / Category manager</td>
            ...
            <td>An inventory Manager can:<ul>
                <li>Work inside an office and be responsible for the purchase/procurement process</li>
                <li>Work inside a warehouse/Point of Sale to process inbound / perform quality check of products</li></ul>
</td>
        </tr>
           <tr>
            <td>Sales Manager</td>
            <td>A person who manages the clients' orders. This person is on the frontline of customer-store interaction.</td>
        </tr>
           <tr>
            <td>Marketplace Operator (Company)</td>
           ...
           <tr>
            ...
            <td>A merchant is a company that sells own products on an online marketplace</td>
        </tr>
           <tr>
            <td>B2B Manager</td>
            <td>Manages B2B accounts and establishes business relationships with the existing and potential B2B buyers.</td>
        </tr>
           <tr>
            <td>Site Administrator / DevOps</td>
            <td>Their main tasks is the upkeep of all business-critical systems, especially websites and systems available for public access, making sure all business- critical systems are available, reliable, and work as intended.</td>
