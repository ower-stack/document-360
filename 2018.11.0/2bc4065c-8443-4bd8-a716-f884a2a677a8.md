...
1. Update `spryker/product-option` to at least version 6.0.0. See [Migration Guide - Product Option](https://documentation.spryker.com/v4/docs/mg-product-option).
...
**See also:**
* [Learn more about Product options](https://documentation.spryker.com/v4/docs/product-options-2)
* [Learn how to migrate Product option](https://documentation.spryker.com/v4/docs/mg-product-option)
