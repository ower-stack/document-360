...
@(Warning)()(Make sure when prices are exported, created, updated, or deleted manually in Zed UI, they are exported (or removed) to Redis accordingly.)

| Storage Type | Target Entity | Example Expected Data Identifier | 
| --- | --- | --- | --- |
| Redis | Product Abstract Price | `kv:price_product_abstract_merchant_relationship:de:1:1` | 
| Redis | Product Concrete Price | `kv:price_product_concrete_merchant_relationship:de:1:1` | cell |
...
@(Warning)()(Make sure that the price range filter is not displayed on the catalog page.)

See also:
[Prices per Merchant Relation feature overview](https://documentation.spryker.com/v4/docs/price-per-merchant-relation)
 
