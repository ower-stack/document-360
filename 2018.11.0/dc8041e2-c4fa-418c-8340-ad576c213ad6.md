...
To enforce the secure coding practices, our team has improved a custom code sniffer, that prevents usage of potentially vulnerable code patterns. You can find an overview of the sniffer tool in the [Code Sniffer](https://documentation.spryker.com/v4/docs/code-sniffer) article. We recommend using a code sniffer when developing a project that uses our Commerce OS.
...
See [Secure Coding Practices](https://documentation.spryker.com/v4/docs/secure-coding-practices) for a list of secure coding recommendations.