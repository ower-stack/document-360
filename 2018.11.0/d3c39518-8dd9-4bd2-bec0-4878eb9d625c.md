...
1. Installl/update `spryker/cms-block` to at least Version 2.0.0. For more information, see [Migration Guide - CMS Block](https://documentation.spryker.com/v4/docs/mg-cms-block).
