...
* [State Machine Commands, Conditions and Events](https://documentation.spryker.com/v4/docs/payone-state-machine-cmd-cond-evnt.htm)
* [Payone Facade](https://documentation.spryker.com/v4/docs/payone-facade.htm)
* [Authorization and Preauthorization-Capture flows](https://documentation.spryker.com/v4/docs/payone-authorization-and-preauthorization-capture-flows.htm)
