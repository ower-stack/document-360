...
The script can be found in [Migration Guide - CMS Block Category Connector Console](https://documentation.spryker.com/v4/docs/mg-cms-block-category-connector-console).
...
* [Get a general idea about CMS Block Category Connector](https://documentation.spryker.com/v4/docs/cms-block)


_Last review date: Aug 30, 2017_ <!-- by Denis Turkov -->