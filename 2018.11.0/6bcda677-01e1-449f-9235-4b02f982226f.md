...
For more details on how Publish & Sync works, see [Publish and Synchronization ](https://documentation.spryker.com/v4/docs/publish-and-synchronization).
...
* If you want to know more about the building blocks of Spryker, see [Programming Concepts](https://documentation.spryker.com/v4/docs/programming-concepts).