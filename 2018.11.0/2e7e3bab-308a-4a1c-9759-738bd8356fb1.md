...
![Punch out flow](https://spryker.s3.eu-central-1.amazonaws.com/docs/Features/Punch+Out/1.png){height="" width=""}
...
![Suppliers](https://spryker.s3.eu-central-1.amazonaws.com/docs/Features/Punch+Out/erp-suppliers.png){height="" width=""}
...
![Supplier store](https://spryker.s3.eu-central-1.amazonaws.com/docs/Features/Punch+Out/supplier-store.png){height="" width=""}
...
![Shopping cart supplier](https://spryker.s3.eu-central-1.amazonaws.com/docs/Features/Punch+Out/shopping-cart-supplier.png){height="" width=""}
...
![Punch out cart](https://spryker.s3.eu-central-1.amazonaws.com/docs/Features/Punch+Out/cart-punch-out.png){height="" width=""}
...
@(Warning)(Note)(Spyker only provides the user interface in the Back Office where the connection between Spryker Commerce OS and customer's e-procurement system is set up. The ERP-related workflows and logics are managed by our partner [PunchoutCatalogs](https://www.punchoutcatalogs.com/).)
...
![Punch out architecture and database relations](https://spryker.s3.eu-central-1.amazonaws.com/docs/Features/Punch+Out/2.png){height="" width=""}

Database relations are represented in the following schema:
![Schema of database relations](https://spryker.s3.eu-central-1.amazonaws.com/docs/Features/Punch+Out/module-schema-punch-out.png){height="" width=""}
