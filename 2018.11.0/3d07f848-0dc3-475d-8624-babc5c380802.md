...
<div class="mapster-container">
            <img class="mapster-image" src="../Resources/Images/Shop User Guide/Business on Behalf/business-on-behalf-ui.png" usemap="#Map" data-mapster-config="" />
...
1. On the *Your Business Unit* page select the required company account from the drop-down:![](../Resources/Images/Shop User Guide/Business on Behalf/select-another-company-user.png)
...
![](../Resources/Images/Shop User Guide/Business on Behalf/business-unit-changed.png)
