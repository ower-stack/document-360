...
@(Warning)()(See [Activating or Deactivating a Product Option Group in the Back Office](https://documentation.spryker.com/v4/docs/creating-a-product-option) for more details.)
...
![Database scheme](https://spryker.s3.eu-central-1.amazonaws.com/docs/Features/Product+Management/product_options_database_schema1.png){height="" width=""}
...
![Product options storage](https://spryker.s3.eu-central-1.amazonaws.com/docs/Features/Product+Management/product_options_storage.png){height="" width=""}
...
@(Warning)()(See [Creating a New Product Option](https://documentation.spryker.com/v4/docs/creating-a-product-option) to learn more how to create a product option group and assign products in Admin UI.)
...
![Product option warranty](https://spryker.s3.eu-central-1.amazonaws.com/docs/Features/Product+Management/yves-product-option-warranty.png){height="" width=""}
...
You can [assign product labels](https://documentation.spryker.com/v4/docs/creating-a-product-label) to highlight specific products in your shop. Customize the look and text of the labels as they appear in the shop. Any association can be a Label, such as "Sale" or "Christmas". Products that are new in your shop, can be automatically be marked with the Dynamic Product Label "New" for a pre-defined time range.
...
Example:
![Product options example](https://spryker.s3.eu-central-1.amazonaws.com/docs/Features/Product+Management/product_options.png){height="" width=""}
...
* [Creating and Managing Product Options in the Back Office](https://documentation.spryker.com/v4/docs/creating-a-product-option)
* [Migration Guide - Product Option](https://documentation.spryker.com/v4/docs/mg-product-option)
