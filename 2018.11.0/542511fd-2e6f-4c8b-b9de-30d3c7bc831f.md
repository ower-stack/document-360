...
**See also:**
* [Get a general idea about the Navigation feature](https://documentation.spryker.com/v4/docs/navigation)
* [Migration Guide - NavigationGui](https://documentation.spryker.com/v4/docs/mg-navigation-gui)
