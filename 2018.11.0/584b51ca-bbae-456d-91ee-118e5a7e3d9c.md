...
Don't forget to check out the video tutorial on setting up [Company](https://documentation.spryker.com/v4/docs/company-account-overview) Structure in Spryker [B2B Demo Shop](https://documentation.spryker.com/v4/docs/demoshops#b2b-demo-shop):
