...
ContentBannersRestApi, version 2.0.0 introduces the [Banner content item](https://documentation.spryker.com/v3/docs/content-items-types-module-relations-201907) functionality that allows retrieving its data by the content item key via REST API endpoint for all or a specific locale.
...
1. Upgrade the **ContentBanner** module to version 2.0.0. See [ContentBanner Migration Guide](https://documentation.spryker.com/v3/docs/mg-contentbanner-201907) for  details on how to upgrade.
...
**See also:**
[Learn how to migrate ContentBanner](https://documentation.spryker.com/v3/docs/mg-contentbanner-201907)
