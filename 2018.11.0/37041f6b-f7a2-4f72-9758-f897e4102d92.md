...
![Shipment Module schema](https://spryker.s3.eu-central-1.amazonaws.com/docs/Features/Shopping+Lists/shipment-method-database-schema-2.png){height="" width=""}
...
For more information about the shipment method plugins, see [Shipment Methods Plugins](https://documentation.spryker.com/v4/docs/shipment-method-plugins).
...
_Last review date: Dec 4, 2017_ <!-- by Aurimas Ličkus -->