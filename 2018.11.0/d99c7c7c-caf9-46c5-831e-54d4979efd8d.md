...
![Shipment methods](https://spryker.s3.eu-central-1.amazonaws.com/docs/User+Guides/Shop+User+Guides/Checkout/Shop+Guide+-+Shipment+Step/shipment-step.png){height="" width=""}
...
To learn more on how to proceed with the payment, see [Shop Guide - Payment Step](https://documentation.spryker.com/v4/docs/payment-step-shop-guide-201911)
