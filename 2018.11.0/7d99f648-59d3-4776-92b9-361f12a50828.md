...
***
@(Warning)(Note)(Thresholds for merchant relationships do work only for a certain merchant relationship that was created in the **Merchant Relations** section in Back Office.)

This type of threshold is managed by editing a specific merchant relation. 
 
The list of available merchant relations in the Merchant relationships table is build based on the relations that were previously added to the **Merchant > Merchant Relations** section in Back Office. So those need to be created you can proceed to the minimum order value setup.
...
See _Threshold: Reference Information_ to know more about the hard threshold.
***
...
See _Threshold: Reference Information_ to know more about the soft threshold and its types.
***
