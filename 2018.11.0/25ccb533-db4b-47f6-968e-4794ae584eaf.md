...
* [Publish and Synchronization: General concept](http://documentation.spryker.com/v4/docs/publish-and-synchronization.htm)
* [Publish and Synchronization Reference](http://documentation.spryker.com/v4/docs/publish-and-synchronization-reference.htm)
* [Tutorial - Handling Data - Publish and Synchronization](http://documentation.spryker.com/v4/docs/handling-data-publish-and-synchronization.htm)

_Last review date: November 7th, 2018_ <!-- by Helen Kravchenko, Ruslan Dovhospynyi -->