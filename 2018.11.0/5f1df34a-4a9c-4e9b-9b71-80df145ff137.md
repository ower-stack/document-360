@(Info)()(The following Feature Integration guide expects the basic feature to be in place.The current Feature Integration guide only adds the **Volume Prices** functionality.)
...
@(Warning)(Verification)(Make sure that the following changes have been applied to transfer objects:)

| Transfer | Type | Event | Path |
| --- | --- | --- | --- |
|  `PriceProduct.volumeQuantity` | property | created |  `src/Generated/Shared/Transfer/PriceProductTransfer` |
...
```xml             abstract_sku,concrete_sku,price_type,store,currency,value_net,value_gross,price_data.volume_prices
...
* [Familiarize yourself with the Volume Prices feature](https://documentation.spryker.com/v3/docs/volume-prices.htm)
* [Volume Prices Feature Overview](https://documentation.spryker.com/v3/docs/volume-prices-overview.htm)
