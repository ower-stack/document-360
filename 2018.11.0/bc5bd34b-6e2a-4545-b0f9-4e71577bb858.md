...
***
**Prerequisites**
Once you decide to add a new shipment method, please make sure that you have a carrier company to assign a shipment method. If you don't have an appropriate carrier, please see the _Creating a Carrier Company_ article. You also need to make sure that you have an appropriate tax set in the Taxes > Tax Sets section, see the Taxes article.
***
...
**Back Office**
![image.png](https://cdn.document360.io/9fafa0d5-d76f-40c5-8b02-ab9515d3e879/Images/Documentation/image%28120%29.png){height="" width=""}

**Online Store**
![image.png](https://cdn.document360.io/9fafa0d5-d76f-40c5-8b02-ab9515d3e879/Images/Documentation/image%28121%29.png){height="400" width="300"}