...
@(Warning)(Verification)(Make sure that the following changes have been implemented in your database:)
...
@(Warning)(Verification)(Make sure that the following changes have been implemented in transfer objects:)
...
```
 ...
 @(Warning)(Verification)(To verify that `AvailabilityNotificationSubscriber` is working:)
...
@(Warning)(Verification)( To verify that `AvailabilityNotificationSubscriptionMailTypePlugin`, `AvailabilityNotificationUnsubscribedMailTypePlugin` and `AvailabilityNotificationMailTypePlugin` are working:)
...
@(Warning)(Verification)( To verify that `AvailabilityNotificationAnonymizerPlugin` is working:)
...
@(Warning)(Verification)(To verify that `AvailabilityNotificationSubscriptionCustomerTransferExpanderPlugin` is working:)
...
@(Warning)(Verification)(Make sure that the following URLs are available on Yves:)
...
@(Warning)(Verification)(Make sure that the availability subscription form is present in the *product details* page. To do this, find a concrete product that is out of stock and visit its product details page.)

**See also:**

[Product is Available Again feature overview](https://documentation.spryker.com/capabilities/mailing_and_notifications/product_is_available_again/product-is-available-again-201903.htm)
