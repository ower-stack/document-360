...
```bash
composer require spryker-feature/gift-cards:"^201906.0" --update-with-dependencies
```
#### Verification
...
@(Warning)()(Once you've finished the *Setup Behaviour* step, make sure that "NoShipment" shipment method is selected automatically while ordering only a gift card.)
...
@(Warning)(Verification)(Verify the following changes by checking your database:)
...
@(Warning)(Verification)(Make sure that propel entities have been generated successfully by checking their existence. Also, change the generated entity classes to extend from Spryker core classes.)
...
@(Info)()(In this step, you will create a shipment method called "NoShipment". The name of the shipment method has to match the value of `\Spryker\Shared\Shipment\ShipmentConfig::SHIPMENT_METHOD_NAME_NO_SHIPMENT` constant.)
...
<!--![DummyPayment](https://cdn.document360.io/9fafa0d5-d76f-40c5-8b02-ab9515d3e879/Images/Documentation/DummyPayment.svg){height="" width=""}-->
...
@(Info)()(In this step, you should customize your Order State Machine to place orders with 0 price to pay (by using gift cards). The process should skip payment-related steps as there is nothing for the customer to pay any more. Below you can see the example of how NoPayment state machine is defined.)

<details open>
<summary>NoPayment Order State Machine Example</summary>
...
#### Gift card purchase process
@(Info)()(In this step, you'll enable gift card purchasing in your project.)
...
@(Info)()(In this step, you'll enable purchasing with existing gift cards in your project.)
...
_Last review date: Jun 14, 2019_

<!-- Jeremy Fourna, Yuliia Boiko-->