...
@(Info)(Verification)(Make sure that the "Request For Quote" button is not available on the cart page when the quote is in status "Waiting".)

@(Info)(Verification)(Make sure that when you have locked cart after quotation process and request approval for this cart, the cart should stay locked even if approver declined it.)
