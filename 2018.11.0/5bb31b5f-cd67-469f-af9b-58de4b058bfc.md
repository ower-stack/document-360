Spryker Frontend consists of two main parts: Atomic Frontend (JS/CSS/Twg) and Modular Frontend (Widgets and Pages). Both support theming and the same inheritance strategy: Current Theme > Default Theme.
...
To learn how the frontend is being built, use this article.
