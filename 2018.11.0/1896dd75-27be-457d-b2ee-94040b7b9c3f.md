...
For detailed information on queue implementation, see [Spryker Queue Module](https://documentation.spryker.com/v4/docs/queue).
...
* Trigger the **publish** event manually using the [Event Facade](https://documentation.spryker.com/v4/docs/event-adding):
