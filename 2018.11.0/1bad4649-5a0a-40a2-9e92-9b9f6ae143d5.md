...
@(Warning)()(Ensure the following changes were applied to the database:)
...
@(Warning)()(Make sure that the following changes have been applied in transfer objects, see the `src/Generated/Shared/Transfer/` folder:)
...
@(Warning)()(Verify if "console event:trigger --help" has content as an available resource in the list.)
...
@(Warning)()(Verify if "console sync:data --help" has content as an available resource in the list.)

@(Warning)()(Make sure when content banners are exported or created, updated, deleted manually in Zed UI, they are exported (or removed) to Redis accordingly.)
...
@(Warning)()(The data imported should be added to the `spy_content` and `spy_content_localized` tables.)
...
@(Warning)()(Make sure that you can see the **Create/Edit Banner**, **Abstract Product List**, **Product Set**, and **File List** buttons in the *Content Items* section.)

@(Warning)()(Make sure that on the CMS Page and CMS Block edit pages you can see a **Content Item** button with the following drop-down items **Banner**, **Abstract Product List**, **Product Set**, and **File List** in the WYSIWYG editor toolbar.)
...
@(Warning)()(Make sure that on the CMS Page and CMS Block edit pages you can see a new widget representing a block in the WYSIWYG editor toolbar when you add any Content Item using a **Content Item** button.)
...
@(Warning)()(Ensure the following modules have been installed in `vendor/spryker-shop`:)
...
@(Warning)()(Make sure that Content Items inserted in CMS blocks or pages are displayed on Yves.)

<!-- Last review date: Aug 07, 2019 by Stanislav Matveyev, Yuliia Boiko-->