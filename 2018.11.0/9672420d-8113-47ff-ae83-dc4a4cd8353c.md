...
2. On the **Create a Product Attribute** page:
    ...
    @(Warning)(Note)(Keep in mind that it should not contain any special symbols.)
...
***
**What's next?**
Learn how the product attributes are managed in the [Managing Product Attributes](https://documentation.spryker.com/v4/docs/managing-attributes) article. 

Review the _References_ section to learn more about the attributes you populate for the Attribute entity and the examples of how the attributes are used. 