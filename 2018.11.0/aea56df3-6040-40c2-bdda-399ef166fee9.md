...
For [cross sell widgets](econda-cross-sell.htm), we will demonstrate integration of JS SDK that you can download from the [Econda website](http://downloads.econda.de/support/releases/js-sdk/current/econda-recommendations.php).
...
Details on how to work with Javascript and templates in Spryker can be found in [Front-Ende Guide](https://documentation.spryker.com/v4/docs/about-frontend-guide).

Econda module uses collectors to [export data to CSV](https://documentation.spryker.com/v4/docs/econda-export-csvs.htm). Please read more about Collectors.
...
* [Cross Sell - Econda](https://documentation.spryker.com/v4/docs/econda-cross-sell.htm)
* [Exporting CSVs to Econda](https://documentation.spryker.com/v4/docs/econda-export-csvs.htm)
* [Tracking - Econda](https://documentation.spryker.com/v4/docs/econda-tracking.htm)