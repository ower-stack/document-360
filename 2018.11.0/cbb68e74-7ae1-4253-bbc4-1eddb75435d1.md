...
2. On the **Create a Product** page, do the procedure described in the _Creating an Abstract Product_ article:
...
***
**What's next?**
Review the _Creating an Abstract Product_ and _Creating a Product Variant_ articles to learn more about how the products are created. 
