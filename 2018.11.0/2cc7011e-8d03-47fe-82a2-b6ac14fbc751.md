...
The `Caclulator` module also returns `back sales.fk_customer, sales.fk_shipment_method, sales.shipment_delivery_time` - these are deprecated methods. To safely migrate them see [Migration Guide - Sales](link).
...
See  for more information about the hydration plugins. There is also a list of "required by default" plugins.
For out-of-the-box projects the following plugins should be configured as described below.
Create class `Pyz\Zed\Sales\SalesDependencyProvider`, if not already created. Add the new method `SalesDependencyProvider::getOrderHydrationPlugins`.
...
* [Get a general idea about calculation and how it works](https://documentation.spryker.com/v4/docs/calculation)

* [Learn about Calculation Data Structure](https://documentation.spryker.com/v4/docs/calculation-data-structure)

* [Check Calculation Plugins](https://documentation.spryker.com/v4/docs/calculation-plugins)