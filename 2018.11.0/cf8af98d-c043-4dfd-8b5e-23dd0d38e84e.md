...
![Share shopping list](https://spryker.s3.eu-central-1.amazonaws.com/docs/Features/Shopping+Lists/share-shopping+list.png){height="" width=""}
...
![Shared read only shopping list](https://spryker.s3.eu-central-1.amazonaws.com/docs/Features/Shopping+Lists/shared-read-only.png){height="" width=""}
...
![Shared full access](https://spryker.s3.eu-central-1.amazonaws.com/docs/Features/Shopping+Lists/shared-full-access.png){height="" width=""}
...
![Search widget](https://spryker.s3.eu-central-1.amazonaws.com/docs/Features/Shopping+Lists/shopping-list-search-widget.png){height="" width=""}
...
![Subtotal for shopping list](https://spryker.s3.eu-central-1.amazonaws.com/docs/Features/Shopping+Lists/subtotal-for-shopping-list.png){height="" width=""}
...
* [Integrate the Shopping List v. 201907.0 feature into your project](https://documentation.spryker.com/v3/docs/shopping-lists-feature-integration-201907)
* [Integrate the Prices 201907.0 feature int your project](https://documentation.spryker.com/v3/docs/prices-feature-integration-201907)

_Last review date: Jul 29, 2019_ <!-- by Ahmed Saaba, Oksana Karasyova -->