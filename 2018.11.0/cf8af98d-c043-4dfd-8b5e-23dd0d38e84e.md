...
* through a [shopping list widget](https://documentation.spryker.com/v4/docs/shopping-list-widget) in the header of the shop
...
The detailed information on managing shopping lists is covered in the [Shop User Guide](https://documentation.spryker.com/v4/docs/shopping-lists-shop-guide).
...
![Share shopping list](https://spryker.s3.eu-central-1.amazonaws.com/docs/Features/Shopping+Lists/Multiple+and+Shared+Shopping+Lists/Multiple+and+Shared+Shopping+Lists+Overview+v201907.0/share-shopping+list.png){height="" width=""}
...
* Product attribute
* Product options
* Product comments (see [Shopping List Notes](https://documentation.spryker.com/v4/docs/shopping-list-notes) for more details)
* Quantity
* Item price
* Availability
...
3. **Printing shopping list**: See [Printing Shopping list](https://documentation.spryker.com/v4/docs/printing-shopping-list) to learn how it works

4. **Adding shopping list items to cart**: The user can select the necessary which are available and add them to cart
![Shared read only shopping list](https://spryker.s3.eu-central-1.amazonaws.com/docs/Features/Shopping+Lists/Multiple+and+Shared+Shopping+Lists/Multiple+and+Shared+Shopping+Lists+Overview+v201907.0/shared-read-only.png){height="" width=""}
...
1. Reading Shopping list: On the _Shopping List View_ page, the user sees the name of owner, access level (Full access), number of users the shopping list is shared with, as well as table of items with the following information:
   ...
   * Product attribute
   * Product options 
   * Product notes (see [Shopping List Notes](https://documentation.spryker.com/v4/docs/shopping-list-notes) for more details)
   * Quantity
   * Item price
   * Availability
...
3. **Printing shopping list**: See [Printing a Shopping List](https://documentation.spryker.com/v4/docs/printing-shopping-list) to learn how it works
...
![Shared full access](https://spryker.s3.eu-central-1.amazonaws.com/docs/Features/Shopping+Lists/Multiple+and+Shared+Shopping+Lists/Multiple+and+Shared+Shopping+Lists+Overview+v201907.0/shared-full-access.png){height="" width=""}
...
![Search widget](https://spryker.s3.eu-central-1.amazonaws.com/docs/Features/Shopping+Lists/Multiple+and+Shared+Shopping+Lists/Multiple+and+Shared+Shopping+Lists+Overview+v201907.0/shopping-list-search-widget.png){height="" width=""}
...
![Subtotal for shopping list](https://spryker.s3.eu-central-1.amazonaws.com/docs/Features/Shopping+Lists/Multiple+and+Shared+Shopping+Lists/Multiple+and+Shared+Shopping+Lists+Overview+v201907.0/subtotal-for-shopping-list.png){height="" width=""}
