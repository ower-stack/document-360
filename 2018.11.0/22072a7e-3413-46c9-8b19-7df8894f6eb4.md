Billpay offers multiple payment methods (Invoice, Direct Debit, PayLater, Instalment). Availability of payment methods differs from country to country. Please contact Billpay directly or visit the [Billpay websit](https://www.billpay.de/en/business-clients/merchant-request)e  for details.

The Billpay module provides integration with the [Invoice with prescoring](billpay_payment_methods.htm) payment method.
...
See [Configuration Management](http://documentation.spryker.com/resources_and_developer_tools/configuration-management.htm) for more on configuration.
