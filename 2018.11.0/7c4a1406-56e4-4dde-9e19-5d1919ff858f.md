...
@(Info)()(When using the reorder feature, a new customer quote must be created with the name "Cart from order {Order reference}".)
...
-->
_Last review date: Dec 6, 2018_

<!--by Dmitriy Krainiy, Yuliia Boiko-->