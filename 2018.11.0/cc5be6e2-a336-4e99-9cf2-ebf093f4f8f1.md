...
![Tax rate](https://spryker.s3.eu-central-1.amazonaws.com/docs/Features/tax-rate.gif){height="" width=""}

Once the rate is defined, you can attach it to a tax set(s). A tax set can contain from one to many tax rates.
![Tax set](https://spryker.s3.eu-central-1.amazonaws.com/docs/Features/tax-set.gif){height="" width=""}

The described values are defined in the **Back Office** > **Taxes** section.

![Tax section](https://spryker.s3.eu-central-1.amazonaws.com/docs/Features/taxes-section.gif){height="" width=""}