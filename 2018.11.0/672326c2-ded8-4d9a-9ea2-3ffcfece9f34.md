...
@(Info)()(The following imported entities will be used as _productvol_ in Spryker OS.)
...
@(Warning)(Verification)(Make sure that in the database the configured data has been added to the `spy_product_price` table.)
...
<!--**See also:**
[Volume Prices Feature Overview](https://documentation.spryker.com/capabilities/price/volume_prices/volume-prices-overview.htm)
 -->
