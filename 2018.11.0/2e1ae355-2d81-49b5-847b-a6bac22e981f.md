...
| Product | 201907.0 | [Glue: Product Feature Integration](https://documentation.spryker.com/v3/docs/products-feature-integration-201907.htm) |
| Cart | 201907.0 | [Cart Feature Integration](https://docs.demo-spryker.com/v3/docs/cart-feature-integration) |
...
2. Make a request to `http://glue.mysprykershop.com/carts/{{cart_uuid}}/?include=items`. The cart with the given ID should have at least one item in it.
3. Make sure that the response includes relationships to the corresponding cart items resources.
4. Make a request to `http://glue.mysprykershop.com/guest-carts/{{guest_cart_uuid}}/?include=items`. The guest cart with the given ID should have at least one item in it.
