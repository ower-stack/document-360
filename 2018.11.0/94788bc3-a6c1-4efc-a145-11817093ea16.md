...
Configure RabbitMQ permissions and virtual hosts according to the [instructions](http://documentation.spryker.com/tutorials/introduction/setup-hello-world-queue.htm#rabbitmq-management-ui).
...
* [B2C Demo Shop Installation Guide](https://documentation.spryker.com/v4/docs/installation-guide-b2c.htm)
* [Installing Spryker with Custom Set of Modules](https://documentation.spryker.com/v4/docs/installation-guide-chose-modules.htm)
