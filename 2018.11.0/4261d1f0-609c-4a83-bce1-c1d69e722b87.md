...
Thus, Comments feature enables your B2B customers to effectively communicate and discuss the purchases with colleagues, thereby improve customer satisfaction and speed up the process by avoiding additional communication outside of the context.
...
When the order with the attached comments is placed, the Shop Administrator can view it with the comments in the Back Office > Orders. 
...
@(Warning)(Note)(To create a new tag, see this [how-to guide](https://documentation.spryker.com/v3/docs/ht-adding-new-tag-for-comment).)
