...
* To know why and how the product sets are created, see the _Creating a Product Set_ article.
* To know how the product sets are managed, see the _Managing Product Sets_ article.
* To learn the attributes that you see, enter, and select while creating or managing product sets, see the _Product Sets: Reference Information_ article.