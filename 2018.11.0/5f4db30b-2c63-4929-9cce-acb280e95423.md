...
7. **Optionally**: Click **Next** of select the **Assign bundled products** tab. This tab is used only if you need to create a bundles product. See the *Creating and Managing Product Bundles* article to know more.
8. Click **Save**.
***
