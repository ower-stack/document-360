...
Oms version >= 4 is required. See the [Migration Guide - OMS](https://documentation.spryker.com/v4/docs/mg-oms) to version 4 step by step guide how to migrate OMS to have new availability integrated.
...
_Last review date: Feb 26, 2018_
