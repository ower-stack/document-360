...
**Query Builder**
![discount_calculation_query](https://cdn.document360.io/9fafa0d5-d76f-40c5-8b02-ab9515d3e879/Images/Documentation/discount_calculation_query.png){height="" width=""}

**Plain Query**
![discount_calculation_query_plain](https://cdn.document360.io/9fafa0d5-d76f-40c5-8b02-ab9515d3e879/Images/Documentation/discount_calculation_query_plain.png){height="" width=""}
...
@(Info)(Info)(The fields and values are defined by your shop data.)

These tokens are used to build plain queries too. The pattern of the plain query is as follows:
![plain-query-pattern](https://cdn.document360.io/9fafa0d5-d76f-40c5-8b02-ab9515d3e879/Images/Documentation/plain-query-pattern.png){height="" width=""}
...
@(Info)(Info)(See the _Token Description Tables_ article for more information.)
...
![Application type](https://cdn.document360.io/9fafa0d5-d76f-40c5-8b02-ab9515d3e879/Images/Documentation/Application%20type.png){height="" width=""}
***
