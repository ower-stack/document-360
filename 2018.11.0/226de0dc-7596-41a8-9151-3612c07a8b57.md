[Customer Login by Token](https://documentation.spryker.com/v3/docs/customer-login-by-token) feature allows B2B users to log in to a Spryker Shop using a token.
