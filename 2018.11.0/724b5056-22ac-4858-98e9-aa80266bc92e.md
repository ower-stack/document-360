...
1. Update/install `spryker/collector` to at least 6.0.0 version. See [Migration Guide - Collector](https://documentation.spryker.com/v4/docs/mg-collector) for more details.
...
Additionally you might want to update the Product Information Management (PIM) Zed Admin UI to manage abstract products and their store configuration. You can find further information about multi-store products here, and [Migration Guide - ProductManagement](https://documentation.spryker.com/v4/docs/mg-product-management).
...
The Product module does not provide the tax functionality anymore. Upgrade [Migration Guide - Tax](https://documentation.spryker.com/v4/docs/mg-tax).

**See also:**
* [Learn how to upgrade Collector](https://documentation.spryker.com/v4/docs/mg-collector)
<!--* Learn more about Products in multi-store environment-->
* [Learn how to migrate ProductManagement](https://documentation.spryker.com/v4/docs/mg-product-management)

<!-- Last review date: Jan 23, 2018 by Karoly Gerner -->