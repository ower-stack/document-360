...
@(Info)()(To find out more information about the attributes that you see on the **Edit Discount** page, see the _Discount: Reference Information_ article.)
***
## Viewing a Discount
...
1. On the **Overview of Discounts** page, click **Add code** in the _Actions_ column.
    ...
    Follow the steps described in the _Creating a Discount Voucher_ article.
