...
@(Info)()(To find out more information about the attributes that you see on the **Edit Discount** page, see [Discount: Reference Information](https://documentation.spryker.com/v4/docs/discount-reference-information).)
***
## Viewing a Discount
...
1. On the **Overview of Discounts** page, click **Add code** in the _Actions_ column.
    ...
    Follow the steps described in the [Creating a Discount Voucher](https://documentation.spryker.com/v4/docs/creating-a-discount-voucher) article.
