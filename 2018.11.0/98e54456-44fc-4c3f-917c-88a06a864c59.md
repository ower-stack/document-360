...
![Product bundle entity diagram](https://spryker.s3.eu-central-1.amazonaws.com/docs/Features/Product+Management/product_bundles_entity_diagram.png){height="" width=""}
