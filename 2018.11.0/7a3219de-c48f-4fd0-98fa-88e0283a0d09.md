This HowTo article provides the instructions on how to integrate the Direct Debit payment form and handler into Checkout.
...
<!--@(Error)()(If you re-created this example in Demoshop, perform some adjustments on the `selectPayment()` from `checkout.js`.)-->
***
**What's next?**

Once done, you need to [create and integrate the Direct Debit payment method in the back-end](https://documentation.spryker.com/v4/docs/dd-be-implementation).
