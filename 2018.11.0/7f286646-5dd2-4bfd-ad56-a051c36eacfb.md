...
@(Warning)()(If you are using a devvm version lower than 2.2.0, run the *ulimit -n 65535* command at first.)
...
Configure RabbitMQ permissions and virtual hosts according to the [instructions](http://documentation.spryker.com/v4/docs/setup-hello-world-queue.htm#rabbitmq-management-ui).
