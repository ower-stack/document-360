...
![Product is available again notification](https://spryker.s3.eu-central-1.amazonaws.com/docs/About/Release+notes/2019-03/image6.png){height="" width=""}

**Documentation**: [Product is Available Again](https://documentation.spryker.com/v2/docs/product-is-available-again).
...
![Discount on group of products](https://spryker.s3.eu-central-1.amazonaws.com/docs/About/Release+notes/2019-03/image1.png){height="" width=""}
...
![Back Office translated to multiple languages](https://spryker.s3.eu-central-1.amazonaws.com/docs/About/Release+notes/2019-03/image8.png){height="" width=""}
...
![Supporting unlimited number of categories](https://spryker.s3.eu-central-1.amazonaws.com/docs/About/Release+notes/2019-03/image3.png){height="" width=""}
...
![Multi-store support for CMS pages](https://spryker.s3.eu-central-1.amazonaws.com/docs/About/Release+notes/2019-03/image9.png){height="" width=""}
...
![CMS pages in search results](https://spryker.s3.eu-central-1.amazonaws.com/docs/About/Release+notes/2019-03/image7.png){height="" width=""}
...
![New template for category page](https://spryker.s3.eu-central-1.amazonaws.com/docs/About/Release+notes/2019-03/image2.png){height="" width=""}
...
![CMS block widget](https://spryker.s3.eu-central-1.amazonaws.com/docs/About/Release+notes/2019-03/image5.png){height="" width=""}
...
**Documentation**: [Configuring Visibility of the Included Section](https://documentation.spryker.com/v2/docs/ht-configuring-visibility-included-section-201903).
...
![Quick order improvements](https://spryker.s3.eu-central-1.amazonaws.com/docs/About/Release+notes/2019-03/image10.png){height="" width=""}
...
![Approval process](https://spryker.s3.eu-central-1.amazonaws.com/docs/About/Release+notes/2019-03/image4.png){height="" width=""}
...
**Documentation**: [Checkout](https://documentation.spryker.com/v4/docs/delivery-address-step-shop-guide), [Business on Behalf](https://documentation.spryker.com/v2/docs/business-on-behalf-201903), [Reclamations](https://documentation.spryker.com/v2/docs/reclamations-201903).
...
**Documentation**: [Heidelpay - Split-payment Marketplace](https://documentation.spryker.com/v4/docs/heidelpay-split-payment-marketplace).
