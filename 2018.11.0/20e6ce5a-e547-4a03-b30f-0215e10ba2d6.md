...
1. Update / install `spryker/product` to at least 6.0.0 version. See [Migration Guide - Product](https://documentation.spryker.com/v4/docs/mg-product) for more details.
...
You should be able now to see the "abstract product-store" relations in the Product Information Management (PIM) Back Office, however you will not able to manage / change anything yet. If you would like to enable the entire multi-store product behavior, see [Multi-Store Products Feature Integration](https://documentation.spryker.com/v4/docs/product-store-relation-feature-integration). 
...
* [Learn more about Products in multi-store environment](https://documentation.spryker.com/v4/docs/product-store-relation)
