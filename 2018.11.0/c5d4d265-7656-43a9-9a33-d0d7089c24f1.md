...
![Reorder](https://spryker.s3.eu-central-1.amazonaws.com/docs/About/Archive/reorder_view_orders.png){height="" width=""}
 
![Reorder - View details](https://spryker.s3.eu-central-1.amazonaws.com/docs/About/Archive/reorder_order_details.png){height="" width=""}
...
* [Entity Manager](https://documentation.spryker.com/v4/docs/entity-manager)
* [Repository](https://documentation.spryker.com/v4/docs/repository)
* [Payment Integration - Computop](https://documentation.spryker.com/v4/docs/computop)
* [Computop API](https://documentation.spryker.com/v4/docs/computop-api-details)
* [Computop - Credit Card](https://documentation.spryker.com/v4/docs/computop-credit-card)
* [Computop - Direct Debit](https://documentation.spryker.com/v4/docs/computop-direct-debit)
* [Computop - Easy Credit](https://documentation.spryker.com/v4/docs/computop-easy-credit)
* [Computop - iDeal](https://documentation.spryker.com/v4/docs/computop-ideal)
* [Computop - OMS](https://documentation.spryker.com/v4/docs/computop-oms-details)
* [Computop - Paydirekt](https://documentation.spryker.com/v4/docs/computop-paydirekt)
* [Computop - PayPal](https://documentation.spryker.com/v4/docs/computop-paypal)
* [Computop - Sofort](https://documentation.spryker.com/v4/docs/computop-sofort)
