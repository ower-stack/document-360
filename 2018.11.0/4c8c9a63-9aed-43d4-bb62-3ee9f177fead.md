...
| --- | --- | --- |
| Get a general idea of the Company Account feature | [Create and manage Companies](https://documentation.spryker.com/v4/docs/managing-companies)  | [Create a new Company](https://documentation.spryker.com/v4/docs/company-account-shop-guide) |
| [Migrate CompanyUser module from version 1.* to version 2.*](https://documentation.spryker.com/v4/docs/mg-companyuse) | [Create and manage Business Units](https://documentation.spryker.com/v4/docs/managing-company-units) | [Create a new Company User](https://documentation.spryker.com/v4/docs/company-users-shop-guide )|
| [Integrate the Company Account v. 201907.0 into your project](https://documentation.spryker.com/v4/docs/company-account-integration-201907) | [Create and manage Company Unit Addresses](%28https://documentation.spryker.com/v4/docs/managing-company-unit-addresses)| [Create a Company Role](https://documentation.spryker.com/v4/docs/company-roles-shop-guide ) |
|  | [Create and manage Company Users](https://documentation.spryker.com/v4/docs/managing-company-users )|  | 
