...
1.     Create a file with predefined product price schedules. See _Scheduled Prices: Reference information_.
2.     Enter and select the attributes for your price schedule. _See Scheduled Prices: Reference information_.
