This article describes the procedure of editing alternative products.
***
...
3. In the **Variants** tab, perform the actions described in the [Updating a Product Variant](https://documentation.spryker.com/v4/docs/updating-a-product-variant) article. 
