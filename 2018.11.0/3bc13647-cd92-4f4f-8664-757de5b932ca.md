...
* [Creating and structuring categories](https://documentation.spryker.com/v4/docs/category)

* [Creating and managing category filters](https://documentation.spryker.com/v4/docs/category-filters)

_Last review date: Feb 19, 2019_ <!-- by Alexey Kravchenko, Andrii Tserkovnyi -->