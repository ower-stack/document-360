...
![Filter by product labels](https://spryker.s3.eu-central-1.amazonaws.com/docs/About/Archive/RN_filter_by_product_labels.gif){height="" width=""}
...
**Documentation**
For module documentation, see [Product Label Module Guide](https://documentation.spryker.com/v4/docs/product-label)
For detailed migration guides, see [Product Label Migration Guide](https://documentation.spryker.com/v4/docs/mg-product-label).
...
**Documentation**
For module documentation, see [HowTo - Import Data](https://documentation.spryker.com/v4/docs/ht-data-import).
...
![Category template Yves](https://spryker.s3.eu-central-1.amazonaws.com/docs/About/Archive/RN_category_template_and_cms_block_position_1.gif){height="" width=""}

![Category template Zed](https://spryker.s3.eu-central-1.amazonaws.com/docs/About/Archive/RN_category_template_and_cms_block_position_2.gif){height="" width=""}
...
* [CMS Block Category Connector Module Guide](https://documentation.spryker.com/v4/docs/cms-block-category-connector)
* [Content Management Module Guide](https://documentation.spryker.com/v4/docs/cms)

For migration guides, see: 

* [Category Migration Guide](https://documentation.spryker.com/v4/docs/mg-category) 
*[CMS Block Category Connector Migration Guide](https://documentation.spryker.com/v4/docs/mg-cms-block-category-connector)
* Category Template Migration Console <!-- add a link -->
* [CMS Block Category Connector Migration Console](https://documentation.spryker.com/v4/docs/mg-cms-block-category-connector-console)
