...
```PHP
composer require spryker-feature/catalog:"^201902.0" spryker-feature/cms:"^201902.0" spryker-shop/tabs-widget-extension:"^1.0.0" --update-with-dependencies 
```
...
Run the following console command to import it ```shelldata:console data:import glossary ```
...
|Module|Test|
|---|---|
|`FullTextSearchTabsWidget`|Go to the full-text search page (by searching for something in the search bar) and search for a term that matches some products and CMS pages as well.|

@(Warning)(Verification)(Make sure that the tabs component displays the activated tab items properly at the top of the search results.)

**See also:**
* [CMS page search + Product Lists Integration Guide](https://documentation.spryker.com/v2/docs/cms-page-search-product-lists-integration-201903)
