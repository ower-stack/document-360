...
@(Warning)()(Make sure that propel entities have been generated successfully by checking their existence. Also, change the generated entity classes to extend from Spryker core classes.)
...
@(Warning)()(Make sure that the following changes have been implemented in transfer objects:)
...
```bash
composer require spryker-feature/category-image:"^201906.0" --update-with-dependencies
```

@(Info)()(Make sure that the following modules have been installed:)
...
@(Info)()(Make sure that the following widgets have been registered:)
