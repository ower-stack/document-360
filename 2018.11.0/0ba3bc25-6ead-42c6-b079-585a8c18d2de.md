...
![Spryker Glue REST API](https://spryker.s3.eu-central-1.amazonaws.com/docs/About/Release+notes/2018-12/image4.jpg){height="" width=""}
...
**Documentation**: [Catalog Search](https://documentation.spryker.com/v4/docs/catalog-search).
...
**Documentation**: [Managing Customers](https://documentation.spryker.com/v4/docs/managing-customers).
...
**Documentation**: [Managing Carts](https://documentation.spryker.com/v4/docs/managing-carts).
...
**Documentation**: [Managing Customers](https://documentation.spryker.com/v4/docs/managing-customers), [Managing Wishlists](https://documentation.spryker.com/v4/docs/managing-wishlists), [Retrieving Customer's Order History](https://documentation.spryker.com/v4/docs/retrieving-order-history).

## Documentation Swagger Generator
![Documentation Swagger generator](https://spryker.s3.eu-central-1.amazonaws.com/docs/About/Release+notes/2018-12/image3.png){height="" width=""}
...
**Documentation**: [REST API Reference](https://documentation.spryker.com/v4/docs/rest-api-reference).

## B2C API React Example
![B2C API React example](https://spryker.s3.eu-central-1.amazonaws.com/docs/About/Release+notes/2018-12/image2.png){height="" width=""}
...
![B2C demo shop](https://spryker.s3.eu-central-1.amazonaws.com/docs/About/Release+notes/2018-12/image1.png){height="" width=""}

### B2B Demo Shop
Our B2B Demo Shop interface has been updated to be responsive on every device.
![B2B demo shop](https://spryker.s3.eu-central-1.amazonaws.com/docs/About/Release+notes/2018-12/image5.png){height="" width=""}