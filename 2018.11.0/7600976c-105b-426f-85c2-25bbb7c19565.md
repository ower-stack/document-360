...
* [Get a general idea of the Timed Product Availability feature](https://documentation.spryker.com/v4/docs/product_ttl)
* [Enabling the Validity module for the Timed Product Availability feature](https://documentation.spryker.com/v4/docs/mg-product-validity)

_Last review date: Feb 23, 2018_ <!-- by Kyrylo Khatsko -->