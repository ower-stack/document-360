This article describes how you create and manage the Merchant Relations in Back Office.
***
...
The merchant is created and can be used to create merchant specific prices (see the _Creating an Abstract Product_, _Creating a Product Variant_ articles to know more). As well as they can be used to create merchant relationship thresholds (see _Managing Merchant Relationships Thresholds_ article).
***
...
![image.png](https://cdn.document360.io/9fafa0d5-d76f-40c5-8b02-ab9515d3e879/Images/Documentation/image%2885%29.png){height="" width=""}
