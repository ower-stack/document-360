The [list of console commands](https://documentation.spryker.com/v4/docs/getting-the-list-of-console-commands-and-available-options) contains the command names together with a short description of what the command does. The most important commands in Spryker can be split inещ 3 categories : collector commands, order managemenet system commands and setup commands. This article provides details on each of the commands.
