...
@(Info)()(All customers using the Legacy Demoshop can make their project compatible with the new Spryker Commerce OS architecture available starting from the [November release](https://documentation.spryker.com/v4/docs/release-notes-2018-11-0.htm). For details, see [Updating the Legacy Demoshop with SCOS](https://documentation.spryker.com/v4/docs/about-updating.htm).)
...
![img](https://documentation.spryker.com/resources/images/run-git-bash-as-administrator.png)
...
Configure RabbitMQ permissions and virtual hosts according to the [instructions](https://documentation.spryker.com/v4/docs/setup-hello-world-queue.htm#rabbitmq-management-ui).
...
* [B2B Demo Shop Installation Guide](https://documentation.spryker.com/v4/docs/installation-guide-b2b.htm)
* [Installing Spryker with Custom Set of Modules](https://documentation.spryker.com/v4/docs/installation-guide-b2b.htm)
* [Post-Installation Steps and Additional Info](https://documentation.spryker.com/v4/docs/installation-guide-b2b.htm)
* [Troubleshooting](https://documentation.spryker.com/v4/docs/installation-guide-b2b.htm)
