...
* [Get a general idea about Checkout process](https://documentation.spryker.com/v4/docs/checkout)

* [Get acquainted with Checkout Quote Transfer Lifetime](https://documentation.spryker.com/v4/docs/checkout-process)

* [Learn how things are wired together during Checkout process](https://documentation.spryker.com/v4/docs/checkout-process)

* [Get acquainted with Checkout Steps](https://documentation.spryker.com/v4/docs/checkout-steps)

* [Learn about Placing the Order](https://documentation.spryker.com/v4/docs/checkout-steps)
