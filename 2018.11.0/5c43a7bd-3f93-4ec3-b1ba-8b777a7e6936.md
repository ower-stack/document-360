...
@(Info)(Information)(The following imported entities will be used as product price schedules in Spryker OS.)
...
* On the Edit Product page, you can find the *Scheduled prices* tab with your scheduled prices.
</div></section>
