...
***
The attributes that you add are taken from the Products > Attributes section of Back Office. So the attribute you want to define should exist in that section.
***
