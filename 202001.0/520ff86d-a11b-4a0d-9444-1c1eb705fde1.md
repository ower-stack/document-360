...
| `spryker-shop/checkout-page` | 3.0.0 | Migration Guide - CheckoutPage |
| `spryker-shop/customer-page` | 2.0.0 | Migration Guide - CustomerPage |
| `spryker/checkout-rest-api` | 2.0.0 | Migration Guide - CheckoutRestApi |
...
| `spryker/shipment-сheckout-сonnector` | 2.0.0 | Migration Guide - ShipmentCheckoutConnector |
