...
* `http://b2b-mysprykershop.com/` - front-end (Storefront);
* `http://zed.b2b-mysprykershop.com/` - backend (the Back Office).
...
After performing steps **3.7** and **3.8** and making sure that the codebase has been copied completely:
