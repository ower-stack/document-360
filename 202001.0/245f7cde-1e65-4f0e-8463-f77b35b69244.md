...
* Increased the minimum `spryker/cms-block` version in `composer.json` (see [Migration Guide - CMS Block](https://docs.demo-spryker.com/v4/docs/mg-cms-block) for more details).
...
<details open>
<summary>src/Pyz/Zed/CmsBlockStorage/CmsBlockStorageDependencyProvider.php</summary>
