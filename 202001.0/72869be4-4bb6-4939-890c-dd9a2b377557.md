...
@(Warning)(Verification)(Make sure the trans and `transChoice` twig filters are working and using translations from the configured translation files.)
...
@(Warning)(Verification)(Make sure that the locale of the back office matches the locale of the logged in user.)
...
@(Warning)(Verification)(Make sure that plugins work: </br>1. Log into back office.</br>2. Go to the *User Control>User* section.</br>3. Click **Add New User**.</br>4. Check that the **Interface language*** field is available in the *Create new Use*r page.)
