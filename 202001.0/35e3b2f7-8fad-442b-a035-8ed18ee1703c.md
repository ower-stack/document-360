...
@(Info)()(Currently, except for the error handling files, there are no Glue related assets. )
...
Check [HowTo - Change the Location of Static Assets](https://documentation.spryker.com/v4/docs/howto-change-the-location-of-static-assets) for more details.