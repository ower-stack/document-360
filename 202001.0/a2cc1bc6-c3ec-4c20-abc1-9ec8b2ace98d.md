...
@(Info)()(If you want to know how to process carts of registered users, see *Managing Carts of Registered Users*<!--add link-->.)


## Installation
For detailed information on the modules that provide the API functionality and related installation instructions, see *Carts API*<!-- add link-->.
