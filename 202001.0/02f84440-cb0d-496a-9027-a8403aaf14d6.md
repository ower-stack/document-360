...
```
3. Replace all ControllerProviders added to the `Pyz\Yves\ShopApplication\YvesBootstrap::getControllerProviderStack()` with the corresponding `RouteProviderPlugins`.
...
```
These constants have to be replaced in your configuration files with the new ones.
5. Add the new plugins to the dependency providers:
<details open>
...
6. Enable the additional plugins.
<details open>
<summary>Console Zed integration</summary>
...
<details open>
<summary>Router Zed integration</summary>
...
<details open>
<summary>Console Yves integration</summary>
...
<details open>
<summary>Router Yves integration</summary>
...
<details open>
<summary>EventDispatcher Glue integration</summary>
