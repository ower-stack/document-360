...
## Installation
For detailed information on the modules that provide the API functionality and related installation instructions, see [Company Account Feature Integration](https://documentation.spryker.com/v4/docs/company-account-integration-201907).
...
[/company-business-units/{{business_unit_id}}](https://documentation.spryker.com/docs/rest-api-reference#/company-business-units)
...
[/company-business-unit-addresses/{{address_id}}](https://documentation.spryker.com/v4/docs/rest-api-reference#/company-business-unit-addresses)
