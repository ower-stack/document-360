...
A Back Office User can [create an unlimited number of slots](https://documentation.spryker.com/docs/managing-configurable-bundle-templates#creating-a-slot-for-a-configurable-bundle-template) for a template.
:::(Info) (Example)
...
![Config Bundle Schema](https://spryker.s3.eu-central-1.amazonaws.com/docs/Features/Product+Management/Configurable+Bundle/Configurable+Bundle+Schema.png){height="" width=""}
...
* The following products cannot be displayed in the Configurator:
    ...
    - default [product bundles](https://documentation.spryker.com/docs/product-bundle)
    - gift cards
