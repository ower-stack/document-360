...
@(Info)(Info)(The resources exposed by the API provide access to complete navigation trees only. Access to specific navigation elements is not supported.)
...
@(Info)(Info)(For more details on managing navigation trees, see [Navigation](https://documentation.spryker.com/v4/docs/navigation).)
...
[/navigations/{{navigation_id}}](https://documentation.spryker.com/v4/docs/rest-api-reference#/navigations)
...
@(Info)(Info)(Navigation IDs are case sensitive.)
...
See also:
NavigationNavigation API Feature IntegrationMigration Guide: NavigationsRestApi moduleBrowsing a Category TreeCatalog Search
