...
<!-- ../../../../resources/images/releases-archive/rn_attribute_management_for_high_number_of_attributes.png -->
**Affected Modules**
...
**Documentation**
For detailed migration guides, see ProductManagement Module Migration Guide from Version 0.7. to 0.8.<!--/module_migration_guides/mg-product-management.htm)-->
