...
* reference guest cart by **guest user ID**
@(Info)()(The user's unique identifier is passed in the **X-Anonymous-Customer-Unique-Id** header when creating a cart. It is managed by the API client.)
`/guest-cart-items/{{concrete_product_sku}}`
Sample request: `DELETE http://mysprykershop.com/guest-cart-items/177_25913296`
where `177_25913296` is the SKU of the concrete product you want to remove.
**Headers:**
**X-Anonymous-Customer-Unique-Id** - specifies the unique guest user ID.
...
@(Info)()(The user's unique identifier is passed in the **X-Anonymous-Customer-Unique-Id** header when creating a cart. It is managed by the API client.)
`/guest-cart-items/{{concrete_product_sku}}`
Sample request: `PATCH http://mysprykershop.com/guest-cart-items/177_25913296`
where `177_25913296` is the SKU of the concrete product for which to change the quantity.
**Headers:**
**X-Anonymous-Customer-Unique-Id** - specifies the unique guest user ID.
