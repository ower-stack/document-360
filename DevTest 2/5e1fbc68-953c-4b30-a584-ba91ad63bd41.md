...
@(Error)()(Reflection is used here for educational purposes, blindly exposing internal code structure in production might lead to security-related consequences.)
...
@(Info)()(Code snippets below are stripped of doc strings and comments to minimize footprint, it is advised to always correctly specify method signatures to take advantage of IDE autocompletion.)
...
@(Info)(Attention)(Transfer objects have a private propery transferMetadata, which describes all the fields, the easiest is to read it for exercise purposes.)
...
|  Tutorial - Adding a New Module| Creating a new Module |
