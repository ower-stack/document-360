...
}</code></pre></td></tr><tr><td>Elasticsearch</td><td>Product Concrete</td><td ><var>product_concretet:de:en_us:1</var></td><td><pre><code>{
"product-lists": {
"whitelists": [1,2],
"blacklists": [3]
}
...
@(Info)()(Make sure that in the database the configured data are added to the spy_product_list_product_concrete table.)
...
_Last review date: Mar 27, 2019_ <!-- by Karoly Gerner, Oksana Karasyova -->
