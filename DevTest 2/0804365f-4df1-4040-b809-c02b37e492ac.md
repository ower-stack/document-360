...
**Documentation**
For detailed migration guides, see [Sales Module Guide from Version 6.* to 7.*](https://documentation.spryker.com/module_migration_guides/mg-sales.htm).
...
To enable this change, please adjust `\Pyz\Zed\Calculation\CalculationDependencyProvider::getQuoteCalculatorPluginStack` according to [Calculation Migration Guide](https://documentation.spryker.com/module_migration_guides/mg-calculation.htm). Place `InitialGrandTotalCalculatorPlugin()` in the right sequence.
...
* [Fact-Finder - Campaigns](https://documentation.spryker.com/industry_partners/performance/factfinder/search-factfinder-campaigns.htm)
* [Fact-Finder - Recommendation](https://documentation.spryker.com/industry_partners/performance/factfinder/search-factfinder-recommendation.htm)