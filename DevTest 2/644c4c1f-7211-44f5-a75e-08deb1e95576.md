...
@(Warning)()(REST API endpoints shipped by Spryker will be covered by documentation by default. A snapshot of the latest state of Spryker REST API can be found in Spryker Documentation. See Rest API Reference <!-- add a link to https://documentation.spryker.com/glue_rest_api/rest-api-reference.htm. once published-->)
...
For details on REST API controllers, see step _4. Create a Resource Controller_ in the **Implementing a REST API Resource** article.
