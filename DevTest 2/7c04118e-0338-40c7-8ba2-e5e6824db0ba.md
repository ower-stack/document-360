@(Warning)()(Please note, that we do not have [Toran Proxy](https://toranproxy.com/) anymore. We recommend to download all Spryker modules from public [Packagist](https://packagist.org/) from now on.)
...
<!-- ../../../../resources/images/releases-archive/multicurrency_zed.png -->
...
<!-- ../../../../resources/images/releases-archive/category_filters.gif -->
**Affected Modules**
...
<!-- ../../../../resources/images/releases-archive/multiple_quantity.png -->
**Affected Modules**
...
* [Coding Best Practices](https://documentation.spryker.com/guidelines/coding-best-practices.htm)
