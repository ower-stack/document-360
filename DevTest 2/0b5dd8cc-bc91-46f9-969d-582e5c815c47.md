...
<!-- <img src="../../../../Resources/Images/Releases-Archive/RN_selecting_product_variant_in_the_cart.gif" /> -->
...
**Documentation**
For integration guides, see [Cart Integration](https://documentation.spryker.com/feature_integration_guides/cart_-integration.htm). 
...
<!-- <img src="../../../../Resources/Images/Releases-Archive/RN_improvement_and_new_features_for_cms_blocks.gif" /> -->
...
**Documentation**
For relevant documentation, see CMS Block Category Connector, CMS Block Product Connector, CMS Block.

For detailed migration guides, see CMS Migration Guide<!--/module_migration_guides/mg-cms.htm)-->, CMS Block Migration Console<!--/module_migration_guides/mg-cms-block-category-connector-console.htm)-->.
...
**Documentation**
For relevant documentation, see File System File Manager Module Guide<!--capabilities/development/file_system/filesystem.htm)-->, Flysystem Module Guide<!--/capabilities/development/flysystem.htm)-->.
...
<!-- <img src="../../../../Resources/Images/Releases-Archive/RN_on_sale_products.gif" />-->
...
<!-- <img src="../../../../Resources/Images/Releases-Archive/RN_discount_rules_based_on_product_labels.gif" />-->
...
**Documentation**
For relevant documentation, see Product Label Module Guide, Discount Module Guide<!--/administration_interface_guide/discount.htm)-->.
...
**Documentation**
For module documentation, see Payment Module Guide<!--/module_guide/spryker/payment.htm)-->.
For detailed migration guides, see Payment Migration Guide<!--/module_migration_guides/mg-payment.htm)-->.
...
**Documentation**
For module documentation, see CMS WidgetModule Guide<!--/capabilities/cms/cms_widget/cms-widget.htm)-->.
