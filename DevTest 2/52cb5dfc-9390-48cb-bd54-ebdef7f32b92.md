...
2. Update your `spryker/cms-block-collector` module to at least Version 2.0.0. You can find additional guide to migration [here](https://documentation.spryker.com/module_migration_guides/mg-cms-collector.htm).
...
@(Warning)(IMPORTANT)(Even if you have 1 store, the associations between CMS Blocks and stores have to be defined.)
...
CMS Block is ready to be used in multi-store environment. Additionally you might want to update the `spryker/cms-block-gui` Administration Intervace to manage CMS Blocks and their store configuration. You can find further information about multi-store CMS Blocks here, and Zed Admin UI module migration guide [here](https://documentation.spryker.com/module_migration_guides/mg-cms-block-gui.htm).

**See also:**

* [Learn how to migrate CMS Block Collector](https://documentation.spryker.com/module_migration_guides/mg-cms-block-collector.htm)
* [Learn how to migrate CMS Block GUI](https://documentation.spryker.com/module_migration_guides/mg-cms-block-gui.htm)
* [Learn more about Multi-store CMS Block](https://documentation.spryker.com/capabilities/cms/cms_block/cms-block-multistore.htm)
* [Learn how to use CMS blocks](https://documentation.spryker.com/administration_interface_guide/content_management/blocks.htm)

_Last review date: Jan 31, 2018_ 
