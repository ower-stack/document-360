...
<!-- ../../../../resources/images/releases-archive/rn_discount_promotion_products.gif 
../../../../resources/images/releases-archive/rn_discount_promotion_products_zed.gif
-->
**Affected Modules**
...
**Documentation**
For module documentation, see Discount Module GuideM<!--/module_guide/spryker/discount.htm)-->, Extending the Discount Module, Discount Promotions<!--/capabilities/promotions_and_discounts/promotions-discount.htm)-->.
...
<!-- ../../../../resources/images/releases-archive/rn_product_reviews_and_ratings.gif 
../../../../resources/images/releases-archive/rn_product_reviews_and_ratings_zed.gif
-->
**Affected Modules**
...
**Documentation**
For documentation, see Under the Hood - Product Reviews<!--/capabilities/product_management/product_reviews/product-review-under-the-hood.htm)-->, Product Reviews Feature Configuration<!--/feature_integration_guides/product-review-feature-configuration.htm)-->, Filter and Sort by Average Rating<!--capabilities/product_management/product_reviews/product-review-filter-and-sort.htm)-->.

For feature integration, see Feature Integration - Product Reviews<!--/feature_integration_guides/product-review-feature-integration.htm)-->.
...
**Documentation**
For detailed migration guides, see Currency Module Migration Guide from Version 2. to 3.<!--/module_migration_guides/mg-currency.htm)-->.
