@(Info)(Info)(Definitions that are used throughout the feature:)
...
To create an RFQ on behalf of a user, use this instruction [a link to shop guide - creating an RFQ on behalf]. 
