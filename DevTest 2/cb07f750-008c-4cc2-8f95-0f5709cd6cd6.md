...
<!-- ../../../Resources/Images/token-structure.png-->
...
In Spryker Commerce OS, token generation is performed using a facade method, that is why no GUI is present. To generate a token, use this tutorial (link to How to).

Token-based authentication works closely with the _Punch Out_ feature. It allows B2B buyers to log in from their ERP system to a Spryker company user account using a token without entering the username and password and buy the products from Spryker e-commerce shop.
...
<!--../../../Resources/Images/customer-login-by-token-module-relations.png -->
