As Spryker Shop implements the Component Model <!-- https://documentation.spryker.com/front-end_developer_guide/yves/atomic-frontend.htm#component-model--> , adding new functionality to it usually means implementing a new component. In this document, we shall review creation of a new component on the example of a simple block that displays the count of DOM elements of a certain type. To implement it:
...
<!-- ../../../resources/images/frontend/new-component-counter.png -->
