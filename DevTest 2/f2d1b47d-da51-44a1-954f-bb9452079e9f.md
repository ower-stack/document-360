...
@(Info)()(For this configuration, one of the Redis servers should be identified as master using the parameter `alias`.)
...
*Last review date: Feb 19, 2019* <!-- by Pavlo Asaulenko, Andrii Tserkovnyi -->