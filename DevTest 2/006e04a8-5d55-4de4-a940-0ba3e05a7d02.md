...
**Documentation**
For more information on Heidelpay integration, see [Payment Integration - Heidelpay](https://documentation.spryker.com/industry_partners/payment/heidelpay/heidelpay.htm).
...
**Documentation**
For more information, please see the [Risk Solution Services Integration - Arvato](https://documentation.spryker.com/industry_partners/payment/arvato/arvato.htm) documentation.
...
* [Payment Integration - Heidelpay](https://documentation.spryker.com/industry_partners/payment/heidelpay/heidelpay.htm)
* [Risk Solution Services Integration - Arvato 2.0](https://documentation.spryker.com/industry_partners/payment/arvato/v2_0/arvato-2-0.htm)
* [Performance Guidelines](https://documentation.spryker.com/guidelines/performance-guidelines.htm)
* [Performing Core Updates Smoothly](https://documentation.spryker.com/installation/composer.htm#core-updates)
* [CMS Blocks](https://documentation.spryker.com/capabilities/cms/cms_block/cms-block.htm)
* [CMS Pages](https://documentation.spryker.com/capabilities/cms/cms_page/cms-page.htm)
* [Demo Shop](https://documentation.spryker.com/about_spryker/videos___webinars/legacy-demoshop.htm)
* [Navigation](https://documentation.spryker.com/about_spryker/videos___webinars/navigation.htm)
* [Product Groups](https://documentation.spryker.com/about_spryker/videos___webinars/product-groups.htm)
* [Product Management](https://documentation.spryker.com/about_spryker/videos___webinars/product-management.htm)
* [Product Sets](https://documentation.spryker.com/about_spryker/videos___webinars/product-sets.htm)
* [Wishlists](https://documentation.spryker.com/about_spryker/videos___webinars/wishlists.htm)
 
