...
<!-- The resulting folder structure in the example of the Wishlists REST API module:-- ../../../resources/images/wishlists-rest-api-module.png-->
...
@(Error)()(The controller must only provide the request handling flow and must not contain any actual business logic. All operations must be delegated to the corresponding layers.)

@(Warning)()(Requests will be passed to the controller as instances of `RestRequestInterface`, and responses must be provided as `RestResponseInterface` objects.)
...
@(Info)()(For information on how to define the objects and syntax, see How to create transfer objects.<!-- once published, add the following link to How to create... https://documentation.spryker.com/tutorials/howtos/ht-use-transfer-objects-201903.htm -->)
...
_Last review date: Feb 28, 2019_
