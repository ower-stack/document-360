...
* **Read-Only**. For details on the Read only permissions, refer to [this article](https://documentation.spryker.com/v4/docs/shared-cart-feature-overview#read-only).
* **Full Access**. For details on the Full Access permission, check [this article](https://documentation.spryker.com/v4/docs/shared-cart-feature-overview#full-access).
