...
Merchants and merchant relations can be [managed in the Back Office](https://documentatio.spryker.com/4/docs/merchants ). You can also import merchants and merchant relations in bulk from a .csv file. See [HowTo - Import Merchants and Merchant Relations](https://documentation.spryker.com/v4/docs/howto-import-merchants-and-merchant-relations ) for details.

<!--_Last review date: Feb 8, 2019_  Helen Kravchenko -->