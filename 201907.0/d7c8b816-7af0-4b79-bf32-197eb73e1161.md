We use [Webpack](https://webpack.js.org/) and [Oryx](https://documentation.spryker.com/v4/docs/oryx) for transpiling/building the assets and to optimize the resulting output.
