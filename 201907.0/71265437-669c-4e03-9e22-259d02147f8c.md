The **Products** section in Back Office is mostly used by the team members involved in Product Management.
It is used by:
* Inventory Managers
**Products > Availability** section in Back Office
    **Standardized flow of actions for an Inventory Manager**
![Inventory manager Slice-of-Life](https://spryker.s3.eu-central-1.amazonaws.com/docs/User+Guides/Back+Office+User+Guides/Products/Inventory+manager+Slice-of-Life.png){height="" width=""}
...
![Category Manager Slice-of-Life \(Products\)](https://spryker.s3.eu-central-1.amazonaws.com/docs/User+Guides/Back+Office+User+Guides/Products/Category+Manager+Slice-of-Life+%28Products%29.png){height="" width=""}
