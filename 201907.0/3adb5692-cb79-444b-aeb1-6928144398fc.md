...
To implement Arvato RSS you should be familiar with concept of extending the Spryker Commerce OS. See [Extending Spryker](https://documentation.spryker.com/v4/docs/ht-extend-inuse-core) for more details.
