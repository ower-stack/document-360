...
@(Info)(Example)(For example, you have ten products assigned to your category. For five of them, there is a seasonal discount applied. So you need those to be at the top of the list.)
***
...
3. In the _Order_ column, set numbers 1-5 for specific products. 
    @(Warning)(Note)(In case you have several products with the identical order number value, the ordering will be performed based on the _product name_ attribute.)
    @(Info)(Information)(The product with 0 in the _Order_ column will be displayed at the bottom.)
...
**To edit a category:**
1. Click **Edit**.
2. Update the needed values. See _Category: Reference Information_.
3. Click **Save**.
***
## Deleting Categories
...
@(Warning)(Note)(Products assigned to this category will not be deleted. They will be de-assigned and continue to exist in the system. If the same products are assigned to other categories, they will stay assigned to those.)
***
**Tips & Tricks**
