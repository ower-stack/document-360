...
* To know what managing actions you can do with the product lists, see the _Managing Product Lists_ article.
* To know more about the attributes you select and enter while creating a product list, see the _Product Lists: Reference Information_ article.