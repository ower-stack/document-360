...
2. On the **Create Company Unit Address** page:
    ...
    * Enter the City, Zip Code, and Street values to complete the address. Number, Addition to address, Comment, and Labels fields are optional. See the _Company Account: Reference Information_ article to know more about the attributes you select and enter.
...
***
**What's next?**
To know more about the attributes you select and enter on the **Create** and **Edit Company Unit Address** pages, see the _Company Account: Reference Information_ article.
The next step in the company account setup is to created company roles and users. See the _Managing Company Roles_ and _Managing Company Users_ articles.