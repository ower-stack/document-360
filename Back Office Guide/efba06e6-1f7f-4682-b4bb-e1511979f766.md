...
Instead of assigning those to already existing categories, you can collect the products under a new category called, e.g., **Newcomers**. 
...
1. In the **General** tab, enter and select the attributes for your category. See _Category: Reference Information._
2. Enter the attributes of your image set. See Category: Reference Information.
@(Info)()(Small images will be used when subcategories on the parent category page are displayed as a list, while the large images will be used when subcategories are displayed as a grid.)

@(Info)()(Even though you can add several image sets and several images to an image set, out of the box, there is no place in the back end and front end where several image sets or images can be displayed for a category. However, if you still do that, the following logic applies:)
...
4. In the **Image** tab, add an image to the category:
    ...
    2. Enter the attributes of your image set. See _Category: Reference Information_.  
    @(Info)()(Keep in mind that small images will be used when subcategories on the parent category page are displayed as a list, while the large images will be used when subcategories are displayed as a grid.)
...
**What's next?**
The category is created, but there are no products yet. 

Thus, the next step is to assign specific products to the newly created category.

See the _Assigning Products to Categories_ article in the **Related Articles** section.