...
@(Warning)(Note)( To be able to preview a draft of your page, you need to link your Zed account to an Yves account.)
...
3. Select a user you would like to assign to your Zed account.
    @(Warning)(Note)(Keep in mind that a customer **cannot** be assigned to multiple users at a time.)
...
**To preview a draft of your CMS page from the Edit Placeholders editor**, see the _Editing Placeholders_ section.
***
...
**To publish a page from the Edit Placeholders editor**, see the _Edit Placeholders_ section.
***
## Viewing a Page
To view a page:
...
@(Info)()(See  _CMS Page: Reference Information_  to learn more about attributes on this page.)
***
**Tips & Tricks**
...
***
**What's next?**
To know more about the attributes you see, select and enter while managing CMS pages, see the _CMS Pages: Reference Information_ article. 