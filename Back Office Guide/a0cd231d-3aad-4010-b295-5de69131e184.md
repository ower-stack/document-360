...
Review the _References_ section to know more about the attributes you populate for the Attribute entity and the examples of how the attributes are used. 