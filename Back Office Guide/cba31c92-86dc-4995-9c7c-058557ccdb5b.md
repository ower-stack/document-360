...
* To know how product lists are created, see the _Creating a Product List_ article.
* To know how the product lists are managed, see the _Managing Product Lists_ article.
* To know more about the attributes you select and enter when creating or managing product lists, see the _Product Lists: Reference Information_ article.