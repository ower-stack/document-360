...
To know what attributes you see, enter, and select while creating a product variant, see the _Concrete Product: Reference Information_ article.
***
...
5. In the **Price & Tax** tab, set prices and taxes for products:
    ...
    4. **B2B only:** In the **Merchant Price Dimension**, select the merchant relationship to define a special price per merchant relation. See _Merchants_ and _Products: Reference Information_ articles to know more.
...
7. **Optionally**: Click **Next** of select the **Assign bundled products** tab. This tab is used only if you need to create a bundles product. See the _Creating and Managing Product Bundles_ article to know more.
8. Click **Save**.
***
Once you click **Save**, the page is refreshed and you will see two additional tabs: Discontinue and Product Alternatives. See the  _Discontinuing Products_ and _Adding Product Alternatives_ articles to know more.
***
**What's next?**
Once you have set things up, you will most likely need to know what managing actions you can do with your products. See articles in the _Managing Products_ section.