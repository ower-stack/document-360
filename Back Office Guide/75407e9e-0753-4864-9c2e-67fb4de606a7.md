...
***
To start managing order, navigate to the **Sales > Orders** section and click **View** in the _Actions_ column for a specific order.
***
...
1. In the _Trigger all matching states_ section, click **pay**, which is the first status in the flow.
...
</br>**To set statuses for specific items in the order:**
1. In the **Order Items** section, select the items for which the status needs to be changed by selecting the checkboxes on the left of the product image. 
2. In the _Trigger all matching states_ section, click the status that needs to be assigned to those items.

</br>**To set statuses for a specific item in the order:**
In the **Order Items** section, click the status icon in the _Trigger event_ column for a specific order.
***
To know more about the order statuses, see _Orders: Reference Information_ article.
***
## Claiming Orders
...
***
**To create a new reclamation for order:**
...
@(Info)()(Clicking **Back to Orders** in the top right corner of the page prior to saving the changes will discard all the changes and take you to the **Overview of Orders** page.)
***
## Commenting the Orders
You can leave notes for a specific order by commenting it.
***
_For example_, if you want your team members to know that you are responsible for managing a specific order, you can leave a comment about that. 
...
![Edit Billing Address button](https://cdn.document360.io/9fafa0d5-d76f-40c5-8b02-ab9515d3e879/Images/Documentation/edit-billing-information.png){height="" width=""}

3. Make the updates and click **Save**.

*Last review date: Sep 19, 2019*
