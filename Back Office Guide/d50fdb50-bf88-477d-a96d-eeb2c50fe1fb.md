...
* To know how you create the product relation, see the _Creating a Product Relation_ article.
* To know the product relations are managed, see the _Managing Product Relations_ article.
* To know more about the attributes that you select and enter while creating or managing a product relation and see some examples of how the product relations look in the online store, see the _Product Relations: Reference Information_ article.
