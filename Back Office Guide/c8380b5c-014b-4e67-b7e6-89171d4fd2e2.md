...
3. In the **Rule** section, enter and select the following and click **Add Rule**:
    ...
    * Action
    * Permission
See [Adding Rules for Roles](https://docs.demo-spryker.com/docs/managing-roles#adding-rules-for-roles) for information on how to create rules.
...
Information about bundles, controllers, and actions is contained in tabs in the Admin UI, and can be retrieved from links. 
