...
* To know how the product labels are managed, see the _Managing Product Labels_ article. 
* To know how you can prioritize the labels, see _Prioritizing Labels_.
* To know more about the attributes you select and enter while creating or managing the labels or see some examples of product labels, see the _References_ section.
