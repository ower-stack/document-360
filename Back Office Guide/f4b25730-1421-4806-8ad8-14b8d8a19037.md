...
@(Info)()(See the _CMS Redirects: Reference Information_ article to learn more information about the attributes you need to enter.)

@(Warning)()(Keep in mind that if you modify the **existing** URL from which a redirect is configured, a new URL will be created and added to the list of CMS redirects.)
***
**Tips & Tricks**
...
***
**What's next?**
To learn more about attributes you enter on the page, see the _CMS Redirects: Reference Information_ article.