...
* To learn more about how to edit a CMS block, see the [Editing CMS Blocks](https://documentation.spryker.com/v4/docs/managing-cms-blocks#editing-blocks) section in the _Managing CMS Blocks_ article.

* To know how you to add blocks to pages, see the [Assigning Blocks to Category and Product details Pages](https://documentation.spryker.com/v4/docs/assigning-blocks-to-category-or-product-pages) article.