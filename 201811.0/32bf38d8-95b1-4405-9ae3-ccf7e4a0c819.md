...
@(Info)()(For information on the different price types available in Spryker, see [Price](https://documentation.spryker.com/v1/docs/price).)
...
@(Info)()(For more information on how to manage product taxes, see [Tax](https://documentation.spryker.com/v1/docs/tax).)
