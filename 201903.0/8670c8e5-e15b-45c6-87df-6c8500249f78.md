To implement Econda plugin you should be familiar with the concept of [extending Spryker](https://documentation.spryker.com/v4/docs/ht-extend-inuse-core.htm) and [plugins.](https://documentation.spryker.com/v4/docs/plugin.htm)
