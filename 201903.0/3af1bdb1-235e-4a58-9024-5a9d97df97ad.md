    ...
    <div class="mr-list-container">
        ...
        <div class="mr-col">
            <ul class="mr-list mr-list-green">
                ...
                <li><a href="https://documentation.spryker.com/v4/docs/business-on-behalf-feature-integration" class="mr-link">Integrate Business on Behalf v. 201903.0 into your project</a></li>
            </ul>
        </div>
         <!-- col2 -->
        <div class="mr-col">
