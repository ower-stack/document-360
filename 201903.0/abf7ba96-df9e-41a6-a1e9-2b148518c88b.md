...
A Page module typically contains a `ControllerProvider` plugin for routing (see [URL Routing](https://documentation.spryker.com/v4/docs/yves-url-routing)) and some Controllers with their twig templates (see [Controllers and Actions](https://documentation.spryker.com/v4/docs/controllers-actions)). The implementation scope of a *Page* module should be decided individually, depending on its need of re-usability. 
...
@(Warning)()(Before you start using the widget system, make sure to register the following plugins:)
...
![MyPage module](https://spryker.s3.eu-central-1.amazonaws.com/docs/Front+End/Modular+Frontend/MyPage_module.png){height="" width=""}
...
For more information on how to create a Widget Plugin, see the *How to Implement a Widget Plugin section* in *Tutorial - Widgets and Widget Plugins*.  <!-- https://documentation.spryker.com/tutorials/advanced/t-widgets-widget-plugins.htm#how-to-implement-a-widget-plugin- -->
