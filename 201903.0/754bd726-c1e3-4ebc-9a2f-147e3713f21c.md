Besides setting [global and merchant relation thresholds](https://documentation.spryker.com/v2/docs/threshold-overview-201903)  for minimum order values manually in the Administration Interface, they can also be imported in bulk from a .csv file.
